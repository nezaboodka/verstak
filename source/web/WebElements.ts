...
export function RxImage<O = void>(id: string, args: any, render: Render<HTMLImageElement, O>, componentRender?: ComponentRender<O, HTMLImageElement>): Manifest<HTMLImageElement, O> { return manifest(id, args, render, componentRender, Html.image) }
...
export function RxSvgLink<O = void>(id: string, args: any, render: Render<SVGAElement, O>, componentRender?: ComponentRender<O, SVGAElement>): Manifest<SVGAElement, O> { return manifest(id, args, render, componentRender, Svg.link) }
