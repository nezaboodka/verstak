...
export function Obj(id: string, render: Render<HTMLObjectElement> = nullRender): Manifest<HTMLObjectElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.object) }
