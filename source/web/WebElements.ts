...
export function RxObject<O = void>(id: string, args: any, render: Render<HTMLObjectElement, O>, componentRender?: ComponentRender<O, HTMLObjectElement>): Manifest<HTMLObjectElement, O> { return manifest(id, args, render, componentRender, HtmlTags.object) }
...
export function A(id: string, render: Render<HTMLAnchorElement> = nullRender): Manifest<HTMLAnchorElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.a) }
export function Abbr(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.abbr) }
export function Address(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.address) }
export function Area(id: string, render: Render<HTMLAreaElement> = nullRender): Manifest<HTMLAreaElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.area) }
export function Article(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.article) }
export function Aside(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.aside) }
export function Audio(id: string, render: Render<HTMLAudioElement> = nullRender): Manifest<HTMLAudioElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.audio) }
export function B(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.b) }
export function Base(id: string, render: Render<HTMLBaseElement> = nullRender): Manifest<HTMLBaseElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.base) }
export function Bdi(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.bdi) }
export function Bdo(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.bdo) }
export function Big(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.big) }
export function BlockQuote(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.blockquote) }
export function Body(id: string, render: Render<HTMLBodyElement> = nullRender): Manifest<HTMLBodyElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.body) }
export function BR(id: string, render: Render<HTMLBRElement> = nullRender): Manifest<HTMLBRElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.br) }
export function Button(id: string, render: Render<HTMLButtonElement> = nullRender): Manifest<HTMLButtonElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.button) }
export function Canvas(id: string, render: Render<HTMLCanvasElement> = nullRender): Manifest<HTMLCanvasElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.canvas) }
export function Caption(id: string, render: Render<HTMLTableCaptionElement> = nullRender): Manifest<HTMLTableCaptionElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.caption) }
export function Cite(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.cite) }
export function Code(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.code) }
export function Col(id: string, render: Render<HTMLTableColElement> = nullRender): Manifest<HTMLTableColElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.col) }
export function ColGroup(id: string, render: Render<HTMLTableColElement> = nullRender): Manifest<HTMLTableColElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.colgroup) }
export function Data(id: string, render: Render<HTMLDataElement> = nullRender): Manifest<HTMLDataElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.data) }
export function DataList(id: string, render: Render<HTMLDataListElement> = nullRender): Manifest<HTMLDataListElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.datalist) }
export function DD(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.dd) }
export function Del(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.del) }
export function Details(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.details) }
export function Dfn(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.dfn) }
export function Dialog(id: string, render: Render<HTMLDialogElement> = nullRender): Manifest<HTMLDialogElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.dialog) }
export function Div(id: string, render: Render<HTMLDivElement> = nullRender): Manifest<HTMLDivElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.div) }
export function DL(id: string, render: Render<HTMLDListElement> = nullRender): Manifest<HTMLDListElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.dl) }
export function DT(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.dt) }
export function EM(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.em) }
export function Embed(id: string, render: Render<HTMLEmbedElement> = nullRender): Manifest<HTMLEmbedElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.embed) }
export function FieldSet(id: string, render: Render<HTMLFieldSetElement> = nullRender): Manifest<HTMLFieldSetElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.fieldset) }
export function FigCaption(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.figcaption) }
export function Figure(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.figure) }
export function Footer(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.footer) }
export function Form(id: string, render: Render<HTMLFormElement> = nullRender): Manifest<HTMLFormElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.form) }
export function H1(id: string, render: Render<HTMLHeadingElement> = nullRender): Manifest<HTMLHeadingElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.h1) }
export function H2(id: string, render: Render<HTMLHeadingElement> = nullRender): Manifest<HTMLHeadingElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.h2) }
export function H3(id: string, render: Render<HTMLHeadingElement> = nullRender): Manifest<HTMLHeadingElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.h3) }
export function H4(id: string, render: Render<HTMLHeadingElement> = nullRender): Manifest<HTMLHeadingElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.h4) }
export function H5(id: string, render: Render<HTMLHeadingElement> = nullRender): Manifest<HTMLHeadingElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.h5) }
export function H6(id: string, render: Render<HTMLHeadingElement> = nullRender): Manifest<HTMLHeadingElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.h6) }
export function Head(id: string, render: Render<HTMLHeadElement> = nullRender): Manifest<HTMLHeadElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.head) }
export function Header(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.header) }
export function HGroup(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.hgroup) }
export function HR(id: string, render: Render<HTMLHRElement> = nullRender): Manifest<HTMLHRElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.hr) }
export function Html(id: string, render: Render<HTMLHtmlElement> = nullRender): Manifest<HTMLHtmlElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.html) }
export function I(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.i) }
export function IFrame(id: string, render: Render<HTMLIFrameElement> = nullRender): Manifest<HTMLIFrameElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.iframe) }
export function Img(id: string, render: Render<HTMLImageElement> = nullRender): Manifest<HTMLImageElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.img) }
export function Input(id: string, render: Render<HTMLInputElement> = nullRender): Manifest<HTMLInputElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.input) }
export function Ins(id: string, render: Render<HTMLModElement> = nullRender): Manifest<HTMLModElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.ins) }
export function Kbd(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.kbd) }
export function KeyGen(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.keygen) }
export function Label(id: string, render: Render<HTMLLabelElement> = nullRender): Manifest<HTMLLabelElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.label) }
export function Legend(id: string, render: Render<HTMLLegendElement> = nullRender): Manifest<HTMLLegendElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.legend) }
export function LI(id: string, render: Render<HTMLLIElement> = nullRender): Manifest<HTMLLIElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.li) }
export function Link(id: string, render: Render<HTMLLinkElement> = nullRender): Manifest<HTMLLinkElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.link) }
export function Main(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.main) }
export function Map(id: string, render: Render<HTMLMapElement> = nullRender): Manifest<HTMLMapElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.map) }
export function Mark(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.mark) }
export function Menu(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.menu) }
export function MenuItem(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.menuitem) }
export function Meta(id: string, render: Render<HTMLMetaElement> = nullRender): Manifest<HTMLMetaElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.meta) }
export function Meter(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.meter) }
export function Nav(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.nav) }
export function NoIndex(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.noindex) }
export function NoScript(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.noscript) }
export function Object(id: string, render: Render<HTMLObjectElement> = nullRender): Manifest<HTMLObjectElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.object) }
export function OL(id: string, render: Render<HTMLOListElement> = nullRender): Manifest<HTMLOListElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.ol) }
export function OptGroup(id: string, render: Render<HTMLOptGroupElement> = nullRender): Manifest<HTMLOptGroupElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.optgroup) }
export function Option(id: string, render: Render<HTMLOptionElement> = nullRender): Manifest<HTMLOptionElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.option) }
export function Output(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.output) }
export function P(id: string, render: Render<HTMLParagraphElement> = nullRender): Manifest<HTMLParagraphElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.p) }
export function Param(id: string, render: Render<HTMLParamElement> = nullRender): Manifest<HTMLParamElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.param) }
export function Picture(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.picture) }
export function Pre(id: string, render: Render<HTMLPreElement> = nullRender): Manifest<HTMLPreElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.pre) }
export function Progress(id: string, render: Render<HTMLProgressElement> = nullRender): Manifest<HTMLProgressElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.progress) }
export function Q(id: string, render: Render<HTMLQuoteElement> = nullRender): Manifest<HTMLQuoteElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.q) }
export function RP(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.rp) }
export function RT(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.rt) }
export function Ruby(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.ruby) }
export function S(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.s) }
export function Samp(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.samp) }
export function Script(id: string, render: Render<HTMLScriptElement> = nullRender): Manifest<HTMLScriptElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.script) }
export function Section(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.section) }
export function Select(id: string, render: Render<HTMLSelectElement> = nullRender): Manifest<HTMLSelectElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.select) }
export function Small(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.small) }
export function Source(id: string, render: Render<HTMLSourceElement> = nullRender): Manifest<HTMLSourceElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.source) }
export function Span(id: string, render: Render<HTMLSpanElement> = nullRender): Manifest<HTMLSpanElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.span) }
export function Strong(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.strong) }
export function Style(id: string, render: Render<HTMLStyleElement> = nullRender): Manifest<HTMLStyleElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.style) }
export function Sub(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.sub) }
export function Summary(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.summary) }
export function Sup(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.sup) }
export function Table(id: string, render: Render<HTMLTableElement> = nullRender): Manifest<HTMLTableElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.table) }
export function Template(id: string, render: Render<HTMLTemplateElement> = nullRender): Manifest<HTMLTemplateElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.template) }
export function TBody(id: string, render: Render<HTMLTableSectionElement> = nullRender): Manifest<HTMLTableSectionElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.tbody) }
export function TD(id: string, render: Render<HTMLTableDataCellElement> = nullRender): Manifest<HTMLTableDataCellElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.td) }
export function TextArea(id: string, render: Render<HTMLTextAreaElement> = nullRender): Manifest<HTMLTextAreaElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.textarea) }
export function TFoot(id: string, render: Render<HTMLTableSectionElement> = nullRender): Manifest<HTMLTableSectionElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.tfoot) }
export function TH(id: string, render: Render<HTMLTableHeaderCellElement> = nullRender): Manifest<HTMLTableHeaderCellElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.th) }
export function THead(id: string, render: Render<HTMLTableSectionElement> = nullRender): Manifest<HTMLTableSectionElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.thead) }
export function Time(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.time) }
export function Title(id: string, render: Render<HTMLTitleElement> = nullRender): Manifest<HTMLTitleElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.title) }
export function TR(id: string, render: Render<HTMLTableRowElement> = nullRender): Manifest<HTMLTableRowElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.tr) }
export function Track(id: string, render: Render<HTMLTrackElement> = nullRender): Manifest<HTMLTrackElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.track) }
export function U(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.u) }
export function UL(id: string, render: Render<HTMLUListElement> = nullRender): Manifest<HTMLUListElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.ul) }
export function Var(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.var) }
export function Video(id: string, render: Render<HTMLVideoElement> = nullRender): Manifest<HTMLVideoElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.video) }
export function Wbr(id: string, render: Render<HTMLElement> = nullRender): Manifest<HTMLElement> { return manifest(id, RefreshWithParent, render, undefined, HtmlTags.wbr) }
...
export function Svg(id: string, render: Render<SVGSVGElement> = nullRender): Manifest<SVGSVGElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.svg) }
export function SvgA(id: string, render: Render<SVGAElement> = nullRender): Manifest<SVGAElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.a) }
export function Animate(id: string, render: Render<SVGAnimateElement> = nullRender): Manifest<SVGAnimateElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.animate) }
export function AnimateMotion(id: string, render: Render<SVGAnimateMotionElement> = nullRender): Manifest<SVGAnimateMotionElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.animateMotion) }
export function AnimateTransform(id: string, render: Render<SVGAnimateTransformElement> = nullRender): Manifest<SVGAnimateTransformElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.animateTransform) }
export function Circle(id: string, render: Render<SVGCircleElement> = nullRender): Manifest<SVGCircleElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.circle) }
export function ClipPath(id: string, render: Render<SVGClipPathElement> = nullRender): Manifest<SVGClipPathElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.clipPath) }
export function Defs(id: string, render: Render<SVGDefsElement> = nullRender): Manifest<SVGDefsElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.defs) }
export function Desc(id: string, render: Render<SVGDescElement> = nullRender): Manifest<SVGDescElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.desc) }
export function Ellipse(id: string, render: Render<SVGEllipseElement> = nullRender): Manifest<SVGEllipseElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.ellipse) }
export function FeBlend(id: string, render: Render<SVGFEBlendElement> = nullRender): Manifest<SVGFEBlendElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feBlend) }
export function FeColorMatrix(id: string, render: Render<SVGFEColorMatrixElement> = nullRender): Manifest<SVGFEColorMatrixElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feColorMatrix) }
export function FeComponentTransfer(id: string, render: Render<SVGFEComponentTransferElement> = nullRender): Manifest<SVGFEComponentTransferElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feComponentTransfer) }
export function FeComposite(id: string, render: Render<SVGFECompositeElement> = nullRender): Manifest<SVGFECompositeElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feComposite) }
export function FeConvolveMatrix(id: string, render: Render<SVGFEConvolveMatrixElement> = nullRender): Manifest<SVGFEConvolveMatrixElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feConvolveMatrix) }
export function FeDiffuseLighting(id: string, render: Render<SVGFEDiffuseLightingElement> = nullRender): Manifest<SVGFEDiffuseLightingElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feDiffuseLighting) }
export function FeDisplacementMap(id: string, render: Render<SVGFEDisplacementMapElement> = nullRender): Manifest<SVGFEDisplacementMapElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feDisplacementMap) }
export function FeDistantLight(id: string, render: Render<SVGFEDistantLightElement> = nullRender): Manifest<SVGFEDistantLightElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feDistantLight) }
export function FeDropShadow(id: string, render: Render<SVGFEDropShadowElement> = nullRender): Manifest<SVGFEDropShadowElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feDropShadow) }
export function FeFlood(id: string, render: Render<SVGFEFloodElement> = nullRender): Manifest<SVGFEFloodElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feFlood) }
export function FeFuncA(id: string, render: Render<SVGFEFuncAElement> = nullRender): Manifest<SVGFEFuncAElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feFuncA) }
export function FeFuncB(id: string, render: Render<SVGFEFuncBElement> = nullRender): Manifest<SVGFEFuncBElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feFuncB) }
export function FeFuncG(id: string, render: Render<SVGFEFuncGElement> = nullRender): Manifest<SVGFEFuncGElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feFuncG) }
export function FeFuncR(id: string, render: Render<SVGFEFuncRElement> = nullRender): Manifest<SVGFEFuncRElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feFuncR) }
export function FeGaussianBlur(id: string, render: Render<SVGFEGaussianBlurElement> = nullRender): Manifest<SVGFEGaussianBlurElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feGaussianBlur) }
export function FeImage(id: string, render: Render<SVGFEImageElement> = nullRender): Manifest<SVGFEImageElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feImage) }
export function FeMerge(id: string, render: Render<SVGFEMergeElement> = nullRender): Manifest<SVGFEMergeElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feMerge) }
export function FeMergeNode(id: string, render: Render<SVGFEMergeNodeElement> = nullRender): Manifest<SVGFEMergeNodeElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feMergeNode) }
export function FeMorphology(id: string, render: Render<SVGFEMorphologyElement> = nullRender): Manifest<SVGFEMorphologyElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feMorphology) }
export function FeOffset(id: string, render: Render<SVGFEOffsetElement> = nullRender): Manifest<SVGFEOffsetElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feOffset) }
export function FePointLight(id: string, render: Render<SVGFEPointLightElement> = nullRender): Manifest<SVGFEPointLightElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.fePointLight) }
export function FeSpecularLighting(id: string, render: Render<SVGFESpecularLightingElement> = nullRender): Manifest<SVGFESpecularLightingElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feSpecularLighting) }
export function FeSpotLight(id: string, render: Render<SVGFESpotLightElement> = nullRender): Manifest<SVGFESpotLightElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feSpotLight) }
export function FeTile(id: string, render: Render<SVGFETileElement> = nullRender): Manifest<SVGFETileElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feTile) }
export function FeTurbulence(id: string, render: Render<SVGFETurbulenceElement> = nullRender): Manifest<SVGFETurbulenceElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.feTurbulence) }
export function Filter(id: string, render: Render<SVGFilterElement> = nullRender): Manifest<SVGFilterElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.filter) }
export function ForeignObject(id: string, render: Render<SVGForeignObjectElement> = nullRender): Manifest<SVGForeignObjectElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.foreignObject) }
export function G(id: string, render: Render<SVGGElement> = nullRender): Manifest<SVGGElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.g) }
export function SvgImage(id: string, render: Render<SVGImageElement> = nullRender): Manifest<SVGImageElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.image) }
export function Line(id: string, render: Render<SVGLineElement> = nullRender): Manifest<SVGLineElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.line) }
export function LinearGradient(id: string, render: Render<SVGLinearGradientElement> = nullRender): Manifest<SVGLinearGradientElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.linearGradient) }
export function Marker(id: string, render: Render<SVGMarkerElement> = nullRender): Manifest<SVGMarkerElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.marker) }
export function Mask(id: string, render: Render<SVGMaskElement> = nullRender): Manifest<SVGMaskElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.mask) }
export function MetaData(id: string, render: Render<SVGMetadataElement> = nullRender): Manifest<SVGMetadataElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.metadata) }
export function MPath(id: string, render: Render<SVGElement> = nullRender): Manifest<SVGElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.mpath) }
export function Path(id: string, render: Render<SVGPathElement> = nullRender): Manifest<SVGPathElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.path) }
export function Pattern(id: string, render: Render<SVGPatternElement> = nullRender): Manifest<SVGPatternElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.pattern) }
export function Polygon(id: string, render: Render<SVGPolygonElement> = nullRender): Manifest<SVGPolygonElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.polygon) }
export function PolyLine(id: string, render: Render<SVGPolylineElement> = nullRender): Manifest<SVGPolylineElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.polyline) }
export function RadialGradient(id: string, render: Render<SVGRadialGradientElement> = nullRender): Manifest<SVGRadialGradientElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.radialGradient) }
export function Rect(id: string, render: Render<SVGRectElement> = nullRender): Manifest<SVGRectElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.rect) }
export function Stop(id: string, render: Render<SVGStopElement> = nullRender): Manifest<SVGStopElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.stop) }
export function SvgSwitch(id: string, render: Render<SVGSwitchElement> = nullRender): Manifest<SVGSwitchElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.switch) }
export function Symbol(id: string, render: Render<SVGSymbolElement> = nullRender): Manifest<SVGSymbolElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.symbol) }
export function Text(id: string, render: Render<SVGTextElement> = nullRender): Manifest<SVGTextElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.text) }
export function TextPath(id: string, render: Render<SVGTextPathElement> = nullRender): Manifest<SVGTextPathElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.textPath) }
export function TSpan(id: string, render: Render<SVGTSpanElement> = nullRender): Manifest<SVGTSpanElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.tspan) }
export function Use(id: string, render: Render<SVGUseElement> = nullRender): Manifest<SVGUseElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.use) }
export function View(id: string, render: Render<SVGViewElement> = nullRender): Manifest<SVGViewElement> { return manifest(id, RefreshWithParent, render, undefined, SvgTags.view) }
