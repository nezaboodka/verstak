...
import { options, reaction, Reentrance, transaction, subscribeless, Transaction, LoggingLevel } from 'reactronic'
...
export class PointerSensor extends BasePointerSensor {
  ...
  @subscribeless private draggingData: unknown
