...
export function A<O = void>(name: string, render?: Render<HTMLAnchorElement, O>, superRender?: SuperRender<O, HTMLAnchorElement>): RxNode<HTMLAnchorElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.a, true) }
export function Abbr<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.abbr, true) }
export function Address<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.address, true) }
export function Area<O = void>(name: string, render?: Render<HTMLAreaElement, O>, superRender?: SuperRender<O, HTMLAreaElement>): RxNode<HTMLAreaElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.area, true) }
export function Article<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.article, true) }
export function Aside<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.aside, true) }
export function Audio<O = void>(name: string, render?: Render<HTMLAudioElement, O>, superRender?: SuperRender<O, HTMLAudioElement>): RxNode<HTMLAudioElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.audio, true) }
export function B<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.b, true) }
export function Base<O = void>(name: string, render?: Render<HTMLBaseElement, O>, superRender?: SuperRender<O, HTMLBaseElement>): RxNode<HTMLBaseElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.base, true) }
export function Bdi<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.bdi, true) }
export function Bdo<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.bdo, true) }
export function Big<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.big, true) }
export function BlockQuote<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.blockquote, true) }
export function Body<O = void>(name: string, render?: Render<HTMLBodyElement, O>, superRender?: SuperRender<O, HTMLBodyElement>): RxNode<HTMLBodyElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.body, true) }
export function BR<O = void>(name: string, render?: Render<HTMLBRElement, O>, superRender?: SuperRender<O, HTMLBRElement>): RxNode<HTMLBRElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.br, true) }
export function Button<O = void>(name: string, render?: Render<HTMLButtonElement, O>, superRender?: SuperRender<O, HTMLButtonElement>): RxNode<HTMLButtonElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.button, true) }
export function Canvas<O = void>(name: string, render?: Render<HTMLCanvasElement, O>, superRender?: SuperRender<O, HTMLCanvasElement>): RxNode<HTMLCanvasElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.canvas, true) }
export function Caption<O = void>(name: string, render?: Render<HTMLTableCaptionElement, O>, superRender?: SuperRender<O, HTMLTableCaptionElement>): RxNode<HTMLTableCaptionElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.caption, true) }
export function Cite<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.cite, true) }
export function Code<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.code, true) }
export function Col<O = void>(name: string, render?: Render<HTMLTableColElement, O>, superRender?: SuperRender<O, HTMLTableColElement>): RxNode<HTMLTableColElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.col, true) }
export function ColGroup<O = void>(name: string, render?: Render<HTMLTableColElement, O>, superRender?: SuperRender<O, HTMLTableColElement>): RxNode<HTMLTableColElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.colgroup, true) }
export function Data<O = void>(name: string, render?: Render<HTMLDataElement, O>, superRender?: SuperRender<O, HTMLDataElement>): RxNode<HTMLDataElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.data, true) }
export function DataList<O = void>(name: string, render?: Render<HTMLDataListElement, O>, superRender?: SuperRender<O, HTMLDataListElement>): RxNode<HTMLDataListElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.datalist, true) }
export function DD<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.dd, true) }
export function Del<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.del, true) }
export function Details<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.details, true) }
export function Dfn<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.dfn, true) }
export function Div<O = void>(name: string, render?: Render<HTMLDivElement, O>, superRender?: SuperRender<O, HTMLDivElement>): RxNode<HTMLDivElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.div, true) }
export function DL<O = void>(name: string, render?: Render<HTMLDListElement, O>, superRender?: SuperRender<O, HTMLDListElement>): RxNode<HTMLDListElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.dl, true) }
export function DT<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.dt, true) }
export function EM<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.em, true) }
export function Embed<O = void>(name: string, render?: Render<HTMLEmbedElement, O>, superRender?: SuperRender<O, HTMLEmbedElement>): RxNode<HTMLEmbedElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.embed, true) }
export function FieldSet<O = void>(name: string, render?: Render<HTMLFieldSetElement, O>, superRender?: SuperRender<O, HTMLFieldSetElement>): RxNode<HTMLFieldSetElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.fieldset, true) }
export function FigCaption<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.figcaption, true) }
export function Figure<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.figure, true) }
export function Footer<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.footer, true) }
export function Form<O = void>(name: string, render?: Render<HTMLFormElement, O>, superRender?: SuperRender<O, HTMLFormElement>): RxNode<HTMLFormElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.form, true) }
export function H1<O = void>(name: string, render?: Render<HTMLHeadingElement, O>, superRender?: SuperRender<O, HTMLHeadingElement>): RxNode<HTMLHeadingElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.h1, true) }
export function H2<O = void>(name: string, render?: Render<HTMLHeadingElement, O>, superRender?: SuperRender<O, HTMLHeadingElement>): RxNode<HTMLHeadingElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.h2, true) }
export function H3<O = void>(name: string, render?: Render<HTMLHeadingElement, O>, superRender?: SuperRender<O, HTMLHeadingElement>): RxNode<HTMLHeadingElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.h3, true) }
export function H4<O = void>(name: string, render?: Render<HTMLHeadingElement, O>, superRender?: SuperRender<O, HTMLHeadingElement>): RxNode<HTMLHeadingElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.h4, true) }
export function H5<O = void>(name: string, render?: Render<HTMLHeadingElement, O>, superRender?: SuperRender<O, HTMLHeadingElement>): RxNode<HTMLHeadingElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.h5, true) }
export function H6<O = void>(name: string, render?: Render<HTMLHeadingElement, O>, superRender?: SuperRender<O, HTMLHeadingElement>): RxNode<HTMLHeadingElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.h6, true) }
export function Head<O = void>(name: string, render?: Render<HTMLHeadElement, O>, superRender?: SuperRender<O, HTMLHeadElement>): RxNode<HTMLHeadElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.head, true) }
export function Header<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.header, true) }
export function HGroup<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.hgroup, true) }
export function HR<O = void>(name: string, render?: Render<HTMLHRElement, O>, superRender?: SuperRender<O, HTMLHRElement>): RxNode<HTMLHRElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.hr, true) }
export function Html<O = void>(name: string, render?: Render<HTMLHtmlElement, O>, superRender?: SuperRender<O, HTMLHtmlElement>): RxNode<HTMLHtmlElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.html, true) }
export function I<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.i, true) }
export function IFrame<O = void>(name: string, render?: Render<HTMLIFrameElement, O>, superRender?: SuperRender<O, HTMLIFrameElement>): RxNode<HTMLIFrameElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.iframe, true) }
export function Img<O = void>(name: string, render?: Render<HTMLImageElement, O>, superRender?: SuperRender<O, HTMLImageElement>): RxNode<HTMLImageElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.img, true) }
export function Input<O = void>(name: string, render?: Render<HTMLInputElement, O>, superRender?: SuperRender<O, HTMLInputElement>): RxNode<HTMLInputElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.input, true) }
export function Ins<O = void>(name: string, render?: Render<HTMLModElement, O>, superRender?: SuperRender<O, HTMLModElement>): RxNode<HTMLModElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.ins, true) }
export function Kbd<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.kbd, true) }
export function KeyGen<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.keygen, true) }
export function Label<O = void>(name: string, render?: Render<HTMLLabelElement, O>, superRender?: SuperRender<O, HTMLLabelElement>): RxNode<HTMLLabelElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.label, true) }
export function Legend<O = void>(name: string, render?: Render<HTMLLegendElement, O>, superRender?: SuperRender<O, HTMLLegendElement>): RxNode<HTMLLegendElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.legend, true) }
export function LI<O = void>(name: string, render?: Render<HTMLLIElement, O>, superRender?: SuperRender<O, HTMLLIElement>): RxNode<HTMLLIElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.li, true) }
export function Link<O = void>(name: string, render?: Render<HTMLLinkElement, O>, superRender?: SuperRender<O, HTMLLinkElement>): RxNode<HTMLLinkElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.link, true) }
export function Main<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.main, true) }
export function Map<O = void>(name: string, render?: Render<HTMLMapElement, O>, superRender?: SuperRender<O, HTMLMapElement>): RxNode<HTMLMapElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.map, true) }
export function Mark<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.mark, true) }
export function Menu<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.menu, true) }
export function MenuItem<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.menuitem, true) }
export function Meta<O = void>(name: string, render?: Render<HTMLMetaElement, O>, superRender?: SuperRender<O, HTMLMetaElement>): RxNode<HTMLMetaElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.meta, true) }
export function Meter<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.meter, true) }
export function Nav<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.nav, true) }
export function NoIndex<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.noindex, true) }
export function NoScript<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.noscript, true) }
export function Obj<O = void>(name: string, render?: Render<HTMLObjectElement, O>, superRender?: SuperRender<O, HTMLObjectElement>): RxNode<HTMLObjectElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.object, true) }
export function OL<O = void>(name: string, render?: Render<HTMLOListElement, O>, superRender?: SuperRender<O, HTMLOListElement>): RxNode<HTMLOListElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.ol, true) }
export function OptGroup<O = void>(name: string, render?: Render<HTMLOptGroupElement, O>, superRender?: SuperRender<O, HTMLOptGroupElement>): RxNode<HTMLOptGroupElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.optgroup, true) }
export function Option<O = void>(name: string, render?: Render<HTMLOptionElement, O>, superRender?: SuperRender<O, HTMLOptionElement>): RxNode<HTMLOptionElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.option, true) }
export function Output<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.output, true) }
export function P<O = void>(name: string, render?: Render<HTMLParagraphElement, O>, superRender?: SuperRender<O, HTMLParagraphElement>): RxNode<HTMLParagraphElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.p, true) }
export function Param<O = void>(name: string, render?: Render<HTMLParamElement, O>, superRender?: SuperRender<O, HTMLParamElement>): RxNode<HTMLParamElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.param, true) }
export function Picture<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.picture, true) }
export function Pre<O = void>(name: string, render?: Render<HTMLPreElement, O>, superRender?: SuperRender<O, HTMLPreElement>): RxNode<HTMLPreElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.pre, true) }
export function Progress<O = void>(name: string, render?: Render<HTMLProgressElement, O>, superRender?: SuperRender<O, HTMLProgressElement>): RxNode<HTMLProgressElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.progress, true) }
export function Q<O = void>(name: string, render?: Render<HTMLQuoteElement, O>, superRender?: SuperRender<O, HTMLQuoteElement>): RxNode<HTMLQuoteElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.q, true) }
export function RP<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.rp, true) }
export function RT<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.rt, true) }
export function Ruby<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.ruby, true) }
export function S<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.s, true) }
export function Samp<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.samp, true) }
export function Script<O = void>(name: string, render?: Render<HTMLScriptElement, O>, superRender?: SuperRender<O, HTMLScriptElement>): RxNode<HTMLScriptElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.script, true) }
export function Section<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.section, true) }
export function Select<O = void>(name: string, render?: Render<HTMLSelectElement, O>, superRender?: SuperRender<O, HTMLSelectElement>): RxNode<HTMLSelectElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.select, true) }
export function Small<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.small, true) }
export function Source<O = void>(name: string, render?: Render<HTMLSourceElement, O>, superRender?: SuperRender<O, HTMLSourceElement>): RxNode<HTMLSourceElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.source, true) }
export function Span<O = void>(name: string, render?: Render<HTMLSpanElement, O>, superRender?: SuperRender<O, HTMLSpanElement>): RxNode<HTMLSpanElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.span, true) }
export function Strong<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.strong, true) }
export function Style<O = void>(name: string, render?: Render<HTMLStyleElement, O>, superRender?: SuperRender<O, HTMLStyleElement>): RxNode<HTMLStyleElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.style, true) }
export function Sub<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.sub, true) }
export function Summary<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.summary, true) }
export function Sup<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.sup, true) }
export function Table<O = void>(name: string, render?: Render<HTMLTableElement, O>, superRender?: SuperRender<O, HTMLTableElement>): RxNode<HTMLTableElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.table, true) }
export function Template<O = void>(name: string, render?: Render<HTMLTemplateElement, O>, superRender?: SuperRender<O, HTMLTemplateElement>): RxNode<HTMLTemplateElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.template, true) }
export function TBody<O = void>(name: string, render?: Render<HTMLTableSectionElement, O>, superRender?: SuperRender<O, HTMLTableSectionElement>): RxNode<HTMLTableSectionElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.tbody, true) }
export function TD<O = void>(name: string, render?: Render<HTMLTableCellElement, O>, superRender?: SuperRender<O, HTMLTableCellElement>): RxNode<HTMLTableCellElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.td, true) }
export function TextArea<O = void>(name: string, render?: Render<HTMLTextAreaElement, O>, superRender?: SuperRender<O, HTMLTextAreaElement>): RxNode<HTMLTextAreaElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.textarea, true) }
export function TFoot<O = void>(name: string, render?: Render<HTMLTableSectionElement, O>, superRender?: SuperRender<O, HTMLTableSectionElement>): RxNode<HTMLTableSectionElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.tfoot, true) }
export function TH<O = void>(name: string, render?: Render<HTMLTableCellElement, O>, superRender?: SuperRender<O, HTMLTableCellElement>): RxNode<HTMLTableCellElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.th, true) }
export function THead<O = void>(name: string, render?: Render<HTMLTableSectionElement, O>, superRender?: SuperRender<O, HTMLTableSectionElement>): RxNode<HTMLTableSectionElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.thead, true) }
export function Time<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.time, true) }
export function Title<O = void>(name: string, render?: Render<HTMLTitleElement, O>, superRender?: SuperRender<O, HTMLTitleElement>): RxNode<HTMLTitleElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.title, true) }
export function TR<O = void>(name: string, render?: Render<HTMLTableRowElement, O>, superRender?: SuperRender<O, HTMLTableRowElement>): RxNode<HTMLTableRowElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.tr, true) }
export function Track<O = void>(name: string, render?: Render<HTMLTrackElement, O>, superRender?: SuperRender<O, HTMLTrackElement>): RxNode<HTMLTrackElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.track, true) }
export function U<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.u, true) }
export function UL<O = void>(name: string, render?: Render<HTMLUListElement, O>, superRender?: SuperRender<O, HTMLUListElement>): RxNode<HTMLUListElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.ul, true) }
export function Var<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.var, true) }
export function Video<O = void>(name: string, render?: Render<HTMLVideoElement, O>, superRender?: SuperRender<O, HTMLVideoElement>): RxNode<HTMLVideoElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.video, true) }
export function Wbr<O = void>(name: string, render?: Render<HTMLElement, O>, superRender?: SuperRender<O, HTMLElement>): RxNode<HTMLElement> { return RxDom.Node(name, undefined, render, superRender, HtmlTags.wbr, true) }
...
export function Svg<O = void>(name: string, render?: Render<SVGSVGElement, O>, superRender?: SuperRender<O, SVGSVGElement>): RxNode<SVGSVGElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.svg) }
export function SvgA<O = void>(name: string, render?: Render<SVGAElement, O>, superRender?: SuperRender<O, SVGAElement>): RxNode<SVGAElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.a) }
export function Animate<O = void>(name: string, render?: Render<SVGAnimateElement, O>, superRender?: SuperRender<O, SVGAnimateElement>): RxNode<SVGAnimateElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.animate) }
export function AnimateMotion<O = void>(name: string, render?: Render<SVGAnimateMotionElement, O>, superRender?: SuperRender<O, SVGAnimateMotionElement>): RxNode<SVGAnimateMotionElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.animateMotion) }
export function AnimateTransform<O = void>(name: string, render?: Render<SVGAnimateTransformElement, O>, superRender?: SuperRender<O, SVGAnimateTransformElement>): RxNode<SVGAnimateTransformElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.animateTransform) }
export function Circle<O = void>(name: string, render?: Render<SVGCircleElement, O>, superRender?: SuperRender<O, SVGCircleElement>): RxNode<SVGCircleElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.circle) }
export function ClipPath<O = void>(name: string, render?: Render<SVGClipPathElement, O>, superRender?: SuperRender<O, SVGClipPathElement>): RxNode<SVGClipPathElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.clipPath) }
export function Defs<O = void>(name: string, render?: Render<SVGDefsElement, O>, superRender?: SuperRender<O, SVGDefsElement>): RxNode<SVGDefsElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.defs) }
export function Desc<O = void>(name: string, render?: Render<SVGDescElement, O>, superRender?: SuperRender<O, SVGDescElement>): RxNode<SVGDescElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.desc) }
export function Ellipse<O = void>(name: string, render?: Render<SVGEllipseElement, O>, superRender?: SuperRender<O, SVGEllipseElement>): RxNode<SVGEllipseElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.ellipse) }
export function FeBlend<O = void>(name: string, render?: Render<SVGFEBlendElement, O>, superRender?: SuperRender<O, SVGFEBlendElement>): RxNode<SVGFEBlendElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feBlend) }
export function FeColorMatrix<O = void>(name: string, render?: Render<SVGFEColorMatrixElement, O>, superRender?: SuperRender<O, SVGFEColorMatrixElement>): RxNode<SVGFEColorMatrixElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feColorMatrix) }
export function FeComponentTransfer<O = void>(name: string, render?: Render<SVGFEComponentTransferElement, O>, superRender?: SuperRender<O, SVGFEComponentTransferElement>): RxNode<SVGFEComponentTransferElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feComponentTransfer) }
export function FeComposite<O = void>(name: string, render?: Render<SVGFECompositeElement, O>, superRender?: SuperRender<O, SVGFECompositeElement>): RxNode<SVGFECompositeElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feComposite) }
export function FeConvolveMatrix<O = void>(name: string, render?: Render<SVGFEConvolveMatrixElement, O>, superRender?: SuperRender<O, SVGFEConvolveMatrixElement>): RxNode<SVGFEConvolveMatrixElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feConvolveMatrix) }
export function FeDiffuseLighting<O = void>(name: string, render?: Render<SVGFEDiffuseLightingElement, O>, superRender?: SuperRender<O, SVGFEDiffuseLightingElement>): RxNode<SVGFEDiffuseLightingElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feDiffuseLighting) }
export function FeDisplacementMap<O = void>(name: string, render?: Render<SVGFEDisplacementMapElement, O>, superRender?: SuperRender<O, SVGFEDisplacementMapElement>): RxNode<SVGFEDisplacementMapElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feDisplacementMap) }
export function FeDistantLight<O = void>(name: string, render?: Render<SVGFEDistantLightElement, O>, superRender?: SuperRender<O, SVGFEDistantLightElement>): RxNode<SVGFEDistantLightElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feDistantLight) }
export function FeDropShadow<O = void>(name: string, render?: Render<SVGFEDropShadowElement, O>, superRender?: SuperRender<O, SVGFEDropShadowElement>): RxNode<SVGFEDropShadowElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feDropShadow) }
export function FeFlood<O = void>(name: string, render?: Render<SVGFEFloodElement, O>, superRender?: SuperRender<O, SVGFEFloodElement>): RxNode<SVGFEFloodElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feFlood) }
export function FeFuncA<O = void>(name: string, render?: Render<SVGFEFuncAElement, O>, superRender?: SuperRender<O, SVGFEFuncAElement>): RxNode<SVGFEFuncAElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feFuncA) }
export function FeFuncB<O = void>(name: string, render?: Render<SVGFEFuncBElement, O>, superRender?: SuperRender<O, SVGFEFuncBElement>): RxNode<SVGFEFuncBElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feFuncB) }
export function FeFuncG<O = void>(name: string, render?: Render<SVGFEFuncGElement, O>, superRender?: SuperRender<O, SVGFEFuncGElement>): RxNode<SVGFEFuncGElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feFuncG) }
export function FeFuncR<O = void>(name: string, render?: Render<SVGFEFuncRElement, O>, superRender?: SuperRender<O, SVGFEFuncRElement>): RxNode<SVGFEFuncRElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feFuncR) }
export function FeGaussianBlur<O = void>(name: string, render?: Render<SVGFEGaussianBlurElement, O>, superRender?: SuperRender<O, SVGFEGaussianBlurElement>): RxNode<SVGFEGaussianBlurElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feGaussianBlur) }
export function FeImage<O = void>(name: string, render?: Render<SVGFEImageElement, O>, superRender?: SuperRender<O, SVGFEImageElement>): RxNode<SVGFEImageElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feImage) }
export function FeMerge<O = void>(name: string, render?: Render<SVGFEMergeElement, O>, superRender?: SuperRender<O, SVGFEMergeElement>): RxNode<SVGFEMergeElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feMerge) }
export function FeMergeNode<O = void>(name: string, render?: Render<SVGFEMergeNodeElement, O>, superRender?: SuperRender<O, SVGFEMergeNodeElement>): RxNode<SVGFEMergeNodeElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feMergeNode) }
export function FeMorphology<O = void>(name: string, render?: Render<SVGFEMorphologyElement, O>, superRender?: SuperRender<O, SVGFEMorphologyElement>): RxNode<SVGFEMorphologyElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feMorphology) }
export function FeOffset<O = void>(name: string, render?: Render<SVGFEOffsetElement, O>, superRender?: SuperRender<O, SVGFEOffsetElement>): RxNode<SVGFEOffsetElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feOffset) }
export function FePointLight<O = void>(name: string, render?: Render<SVGFEPointLightElement, O>, superRender?: SuperRender<O, SVGFEPointLightElement>): RxNode<SVGFEPointLightElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.fePointLight) }
export function FeSpecularLighting<O = void>(name: string, render?: Render<SVGFESpecularLightingElement, O>, superRender?: SuperRender<O, SVGFESpecularLightingElement>): RxNode<SVGFESpecularLightingElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feSpecularLighting) }
export function FeSpotLight<O = void>(name: string, render?: Render<SVGFESpotLightElement, O>, superRender?: SuperRender<O, SVGFESpotLightElement>): RxNode<SVGFESpotLightElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feSpotLight) }
export function FeTile<O = void>(name: string, render?: Render<SVGFETileElement, O>, superRender?: SuperRender<O, SVGFETileElement>): RxNode<SVGFETileElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feTile) }
export function FeTurbulence<O = void>(name: string, render?: Render<SVGFETurbulenceElement, O>, superRender?: SuperRender<O, SVGFETurbulenceElement>): RxNode<SVGFETurbulenceElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.feTurbulence) }
export function Filter<O = void>(name: string, render?: Render<SVGFilterElement, O>, superRender?: SuperRender<O, SVGFilterElement>): RxNode<SVGFilterElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.filter) }
export function ForeignObject<O = void>(name: string, render?: Render<SVGForeignObjectElement, O>, superRender?: SuperRender<O, SVGForeignObjectElement>): RxNode<SVGForeignObjectElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.foreignObject) }
export function G<O = void>(name: string, render?: Render<SVGGElement, O>, superRender?: SuperRender<O, SVGGElement>): RxNode<SVGGElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.g) }
export function SvgImage<O = void>(name: string, render?: Render<SVGImageElement, O>, superRender?: SuperRender<O, SVGImageElement>): RxNode<SVGImageElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.image) }
export function Line<O = void>(name: string, render?: Render<SVGLineElement, O>, superRender?: SuperRender<O, SVGLineElement>): RxNode<SVGLineElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.line) }
export function LinearGradient<O = void>(name: string, render?: Render<SVGLinearGradientElement, O>, superRender?: SuperRender<O, SVGLinearGradientElement>): RxNode<SVGLinearGradientElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.linearGradient) }
export function Marker<O = void>(name: string, render?: Render<SVGMarkerElement, O>, superRender?: SuperRender<O, SVGMarkerElement>): RxNode<SVGMarkerElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.marker) }
export function Mask<O = void>(name: string, render?: Render<SVGMaskElement, O>, superRender?: SuperRender<O, SVGMaskElement>): RxNode<SVGMaskElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.mask) }
export function MetaData<O = void>(name: string, render?: Render<SVGMetadataElement, O>, superRender?: SuperRender<O, SVGMetadataElement>): RxNode<SVGMetadataElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.metadata) }
export function MPath<O = void>(name: string, render?: Render<SVGElement, O>, superRender?: SuperRender<O, SVGElement>): RxNode<SVGElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.mpath) }
export function Path<O = void>(name: string, render?: Render<SVGPathElement, O>, superRender?: SuperRender<O, SVGPathElement>): RxNode<SVGPathElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.path) }
export function Pattern<O = void>(name: string, render?: Render<SVGPatternElement, O>, superRender?: SuperRender<O, SVGPatternElement>): RxNode<SVGPatternElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.pattern) }
export function Polygon<O = void>(name: string, render?: Render<SVGPolygonElement, O>, superRender?: SuperRender<O, SVGPolygonElement>): RxNode<SVGPolygonElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.polygon) }
export function PolyLine<O = void>(name: string, render?: Render<SVGPolylineElement, O>, superRender?: SuperRender<O, SVGPolylineElement>): RxNode<SVGPolylineElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.polyline) }
export function RadialGradient<O = void>(name: string, render?: Render<SVGRadialGradientElement, O>, superRender?: SuperRender<O, SVGRadialGradientElement>): RxNode<SVGRadialGradientElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.radialGradient) }
export function Rect<O = void>(name: string, render?: Render<SVGRectElement, O>, superRender?: SuperRender<O, SVGRectElement>): RxNode<SVGRectElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.rect) }
export function Stop<O = void>(name: string, render?: Render<SVGStopElement, O>, superRender?: SuperRender<O, SVGStopElement>): RxNode<SVGStopElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.stop) }
export function SvgSwitch<O = void>(name: string, render?: Render<SVGSwitchElement, O>, superRender?: SuperRender<O, SVGSwitchElement>): RxNode<SVGSwitchElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.switch) }
export function Symbol<O = void>(name: string, render?: Render<SVGSymbolElement, O>, superRender?: SuperRender<O, SVGSymbolElement>): RxNode<SVGSymbolElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.symbol) }
export function Text<O = void>(name: string, render?: Render<SVGTextElement, O>, superRender?: SuperRender<O, SVGTextElement>): RxNode<SVGTextElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.text) }
export function TextPath<O = void>(name: string, render?: Render<SVGTextPathElement, O>, superRender?: SuperRender<O, SVGTextPathElement>): RxNode<SVGTextPathElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.textPath) }
export function TSpan<O = void>(name: string, render?: Render<SVGTSpanElement, O>, superRender?: SuperRender<O, SVGTSpanElement>): RxNode<SVGTSpanElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.tspan) }
export function Use<O = void>(name: string, render?: Render<SVGUseElement, O>, superRender?: SuperRender<O, SVGUseElement>): RxNode<SVGUseElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.use) }
export function View<O = void>(name: string, render?: Render<SVGViewElement, O>, superRender?: SuperRender<O, SVGViewElement>): RxNode<SVGViewElement> { return RxDom.Node(name, undefined, render, superRender, SvgTags.view) }
