...
export function TD(name: string, render: Render<HTMLTableCellElement> = nullRender): RxNode<HTMLTableCellElement> { return RxDom.Node(name, undefined, render, undefined, HtmlTags.td, true) }
...
export function TH(name: string, render: Render<HTMLTableCellElement> = nullRender): RxNode<HTMLTableCellElement> { return RxDom.Node(name, undefined, render, undefined, HtmlTags.th, true) }
