...
export function Section<M = unknown, R = void>(builder?: BlockBuilder<HTMLElement, M, void, R>, base?: BlockBuilder<HTMLElement, M, void, R>): Block<HTMLElement, M, void, R> { return Verstak.claim(HtmlTags.section, builder, base) }
...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>("a", false, b => b.kind = BlockKind.Raw),
  abbr: new HtmlDriver<HTMLElement>("abbr", false, b => b.kind = BlockKind.Raw),
  address: new HtmlDriver<HTMLElement>("address", false, b => b.kind = BlockKind.Raw),
  area: new HtmlDriver<HTMLAreaElement>("area", false, b => b.kind = BlockKind.Raw),
  article: new HtmlDriver<HTMLElement>("article", false, b => b.kind = BlockKind.Raw),
  aside: new HtmlDriver<HTMLElement>("aside", false, b => b.kind = BlockKind.Raw),
  audio: new HtmlDriver<HTMLAudioElement>("audio", false, b => b.kind = BlockKind.Raw),
  b: new HtmlDriver<HTMLElement>("b", false, b => b.kind = BlockKind.Raw),
  base: new HtmlDriver<HTMLBaseElement>("base", false, b => b.kind = BlockKind.Raw),
  bdi: new HtmlDriver<HTMLElement>("bdi", false, b => b.kind = BlockKind.Raw),
  bdo: new HtmlDriver<HTMLElement>("bdo", false, b => b.kind = BlockKind.Raw),
  big: new HtmlDriver<HTMLElement>("big", false, b => b.kind = BlockKind.Raw),
  blockquote: new HtmlDriver<HTMLElement>("blockquote", false, b => b.kind = BlockKind.Raw),
  body: new HtmlDriver<HTMLBodyElement>("body", false, b => b.kind = BlockKind.Raw),
  br: new HtmlDriver<HTMLBRElement>("br", false, b => b.kind = BlockKind.Raw),
  button: new HtmlDriver<HTMLButtonElement>("button", false, b => b.kind = BlockKind.Raw),
  canvas: new HtmlDriver<HTMLCanvasElement>("canvas", false, b => b.kind = BlockKind.Raw),
  caption: new HtmlDriver<HTMLTableCaptionElement>("caption", false, b => b.kind = BlockKind.Raw),
  cite: new HtmlDriver<HTMLElement>("cite", false, b => b.kind = BlockKind.Raw),
  code: new HtmlDriver<HTMLElement>("code", false, b => b.kind = BlockKind.Raw),
  col: new HtmlDriver<HTMLTableColElement>("col", false, b => b.kind = BlockKind.Raw),
  colgroup: new HtmlDriver<HTMLTableColElement>("colgroup", false, b => b.kind = BlockKind.Raw),
  data: new HtmlDriver<HTMLDataElement>("data", false, b => b.kind = BlockKind.Raw),
  datalist: new HtmlDriver<HTMLDataListElement>("datalist", false, b => b.kind = BlockKind.Raw),
  dd: new HtmlDriver<HTMLElement>("dd", false, b => b.kind = BlockKind.Raw),
  del: new HtmlDriver<HTMLElement>("del", false, b => b.kind = BlockKind.Raw),
  details: new HtmlDriver<HTMLElement>("details", false, b => b.kind = BlockKind.Raw),
  dfn: new HtmlDriver<HTMLElement>("dfn", false, b => b.kind = BlockKind.Raw),
  div: new HtmlDriver<HTMLDivElement>("div", false, b => b.kind = BlockKind.Raw),
  dl: new HtmlDriver<HTMLDListElement>("dl", false, b => b.kind = BlockKind.Raw),
  dt: new HtmlDriver<HTMLElement>("dt", false, b => b.kind = BlockKind.Raw),
  em: new HtmlDriver<HTMLElement>("em", false, b => b.kind = BlockKind.Raw),
  embed: new HtmlDriver<HTMLEmbedElement>("embed", false, b => b.kind = BlockKind.Raw),
  fieldset: new HtmlDriver<HTMLFieldSetElement>("fieldset", false, b => b.kind = BlockKind.Raw),
  figcaption: new HtmlDriver<HTMLElement>("figcaption", false, b => b.kind = BlockKind.Raw),
  figure: new HtmlDriver<HTMLElement>("figure", false, b => b.kind = BlockKind.Raw),
  footer: new HtmlDriver<HTMLElement>("footer", false, b => b.kind = BlockKind.Raw),
  form: new HtmlDriver<HTMLFormElement>("form", false, b => b.kind = BlockKind.Raw),
  h1: new HtmlDriver<HTMLHeadingElement>("h1", false, b => b.kind = BlockKind.Raw),
  h2: new HtmlDriver<HTMLHeadingElement>("h2", false, b => b.kind = BlockKind.Raw),
  h3: new HtmlDriver<HTMLHeadingElement>("h3", false, b => b.kind = BlockKind.Raw),
  h4: new HtmlDriver<HTMLHeadingElement>("h4", false, b => b.kind = BlockKind.Raw),
  h5: new HtmlDriver<HTMLHeadingElement>("h5", false, b => b.kind = BlockKind.Raw),
  h6: new HtmlDriver<HTMLHeadingElement>("h6", false, b => b.kind = BlockKind.Raw),
  head: new HtmlDriver<HTMLHeadElement>("head", false, b => b.kind = BlockKind.Raw),
  header: new HtmlDriver<HTMLElement>("header", false, b => b.kind = BlockKind.Raw),
  hgroup: new HtmlDriver<HTMLElement>("hgroup", false, b => b.kind = BlockKind.Raw),
  hr: new HtmlDriver<HTMLHRElement>("hr", false, b => b.kind = BlockKind.Raw),
  html: new HtmlDriver<HTMLHtmlElement>("html", false, b => b.kind = BlockKind.Raw),
  i: new HtmlDriver<HTMLElement>("i", false, b => b.kind = BlockKind.Raw),
  iframe: new HtmlDriver<HTMLIFrameElement>("iframe", false, b => b.kind = BlockKind.Raw),
  img: new HtmlDriver<HTMLImageElement>("img", false, b => b.kind = BlockKind.Raw),
  input: new HtmlDriver<HTMLInputElement>("input", false, b => b.kind = BlockKind.Raw),
  ins: new HtmlDriver<HTMLModElement>("ins", false, b => b.kind = BlockKind.Raw),
  kbd: new HtmlDriver<HTMLElement>("kbd", false, b => b.kind = BlockKind.Raw),
  keygen: new HtmlDriver<HTMLElement>("keygen", false, b => b.kind = BlockKind.Raw),
  label: new HtmlDriver<HTMLLabelElement>("label", false, b => b.kind = BlockKind.Raw),
  legend: new HtmlDriver<HTMLLegendElement>("legend", false, b => b.kind = BlockKind.Raw),
  li: new HtmlDriver<HTMLLIElement>("li", false, b => b.kind = BlockKind.Raw),
  link: new HtmlDriver<HTMLLinkElement>("link", false, b => b.kind = BlockKind.Raw),
  main: new HtmlDriver<HTMLElement>("main", false, b => b.kind = BlockKind.Raw),
  map: new HtmlDriver<HTMLMapElement>("map", false, b => b.kind = BlockKind.Raw),
  mark: new HtmlDriver<HTMLElement>("mark", false, b => b.kind = BlockKind.Raw),
  menu: new HtmlDriver<HTMLElement>("menu", false, b => b.kind = BlockKind.Raw),
  menuitem: new HtmlDriver<HTMLElement>("menuitem", false, b => b.kind = BlockKind.Raw),
  meta: new HtmlDriver<HTMLMetaElement>("meta", false, b => b.kind = BlockKind.Raw),
  meter: new HtmlDriver<HTMLElement>("meter", false, b => b.kind = BlockKind.Raw),
  nav: new HtmlDriver<HTMLElement>("nav", false, b => b.kind = BlockKind.Raw),
  noindex: new HtmlDriver<HTMLElement>("noindex", false, b => b.kind = BlockKind.Raw),
  noscript: new HtmlDriver<HTMLElement>("noscript", false, b => b.kind = BlockKind.Raw),
  object: new HtmlDriver<HTMLObjectElement>("object", false, b => b.kind = BlockKind.Raw),
  ol: new HtmlDriver<HTMLOListElement>("ol", false, b => b.kind = BlockKind.Raw),
  optgroup: new HtmlDriver<HTMLOptGroupElement>("optgroup", false, b => b.kind = BlockKind.Raw),
  option: new HtmlDriver<HTMLOptionElement>("option", false, b => b.kind = BlockKind.Raw),
  output: new HtmlDriver<HTMLElement>("output", false, b => b.kind = BlockKind.Raw),
  p: new HtmlDriver<HTMLParagraphElement>("p", false, b => b.kind = BlockKind.Raw),
  param: new HtmlDriver<HTMLElement>("param", false, b => b.kind = BlockKind.Raw),
  picture: new HtmlDriver<HTMLElement>("picture", false, b => b.kind = BlockKind.Raw),
  pre: new HtmlDriver<HTMLPreElement>("pre", false, b => b.kind = BlockKind.Raw),
  progress: new HtmlDriver<HTMLProgressElement>("progress", false, b => b.kind = BlockKind.Raw),
  q: new HtmlDriver<HTMLQuoteElement>("q", false, b => b.kind = BlockKind.Raw),
  rp: new HtmlDriver<HTMLElement>("rp", false, b => b.kind = BlockKind.Raw),
  rt: new HtmlDriver<HTMLElement>("rt", false, b => b.kind = BlockKind.Raw),
  ruby: new HtmlDriver<HTMLElement>("ruby", false, b => b.kind = BlockKind.Raw),
  s: new HtmlDriver<HTMLElement>("s", false, b => b.kind = BlockKind.Raw),
  samp: new HtmlDriver<HTMLElement>("samp", false, b => b.kind = BlockKind.Raw),
  script: new HtmlDriver<HTMLScriptElement>("script", false, b => b.kind = BlockKind.Raw),
  section: new HtmlDriver<HTMLElement>("section", false, b => b.kind = BlockKind.Raw),
  select: new HtmlDriver<HTMLSelectElement>("select", false, b => b.kind = BlockKind.Raw),
  small: new HtmlDriver<HTMLElement>("small", false, b => b.kind = BlockKind.Raw),
  source: new HtmlDriver<HTMLSourceElement>("source", false, b => b.kind = BlockKind.Raw),
  span: new HtmlDriver<HTMLSpanElement>("span", false, b => b.kind = BlockKind.Raw),
  strong: new HtmlDriver<HTMLElement>("strong", false, b => b.kind = BlockKind.Raw),
  style: new HtmlDriver<HTMLStyleElement>("style", false, b => b.kind = BlockKind.Raw),
  sub: new HtmlDriver<HTMLElement>("sub", false, b => b.kind = BlockKind.Raw),
  summary: new HtmlDriver<HTMLElement>("summary", false, b => b.kind = BlockKind.Raw),
  sup: new HtmlDriver<HTMLElement>("sup", false, b => b.kind = BlockKind.Raw),
  table: new HtmlDriver<HTMLTableElement>("table", false, b => b.kind = BlockKind.Raw),
  template: new HtmlDriver<HTMLTemplateElement>("template", false, b => b.kind = BlockKind.Raw),
  tbody: new HtmlDriver<HTMLTableSectionElement>("tbody", false, b => b.kind = BlockKind.Raw),
  td: new HtmlDriver<HTMLTableCellElement>("td", false, b => b.kind = BlockKind.Raw),
  textarea: new HtmlDriver<HTMLTextAreaElement>("textarea", false, b => b.kind = BlockKind.Raw),
  tfoot: new HtmlDriver<HTMLTableSectionElement>("tfoot", false, b => b.kind = BlockKind.Raw),
  th: new HtmlDriver<HTMLTableCellElement>("th", false, b => b.kind = BlockKind.Raw),
  thead: new HtmlDriver<HTMLTableSectionElement>("thead", false, b => b.kind = BlockKind.Raw),
  time: new HtmlDriver<HTMLElement>("time", false, b => b.kind = BlockKind.Raw),
  title: new HtmlDriver<HTMLTitleElement>("title", false, b => b.kind = BlockKind.Raw),
  tr: new HtmlDriver<HTMLTableRowElement>("tr", false, b => b.kind = BlockKind.Raw),
  track: new HtmlDriver<HTMLTrackElement>("track", false, b => b.kind = BlockKind.Raw),
  u: new HtmlDriver<HTMLElement>("u", false, b => b.kind = BlockKind.Raw),
  ul: new HtmlDriver<HTMLUListElement>("ul", false, b => b.kind = BlockKind.Raw),
  var: new HtmlDriver<HTMLElement>("var", false, b => b.kind = BlockKind.Raw),
  video: new HtmlDriver<HTMLVideoElement>("video", false, b => b.kind = BlockKind.Raw),
  wbr: new HtmlDriver<HTMLElement>("wbr", false, b => b.kind = BlockKind.Raw),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', BlockKind.Chain),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>("svg", false, b => b.kind = BlockKind.Raw),
  a: new SvgDriver<SVGAElement>("a", false, b => b.kind = BlockKind.Raw),
  animate: new SvgDriver<SVGAnimateElement>("animate", false, b => b.kind = BlockKind.Raw),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>("animateMotion", false, b => b.kind = BlockKind.Raw),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>("animateTransform", false, b => b.kind = BlockKind.Raw),
  circle: new SvgDriver<SVGCircleElement>("circle", false, b => b.kind = BlockKind.Raw),
  clipPath: new SvgDriver<SVGClipPathElement>("clipPath", false, b => b.kind = BlockKind.Raw),
  defs: new SvgDriver<SVGDefsElement>("defs", false, b => b.kind = BlockKind.Raw),
  desc: new SvgDriver<SVGDescElement>("desc", false, b => b.kind = BlockKind.Raw),
  ellipse: new SvgDriver<SVGEllipseElement>("ellipse", false, b => b.kind = BlockKind.Raw),
  feBlend: new SvgDriver<SVGFEBlendElement>("feBlend", false, b => b.kind = BlockKind.Raw),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>("feColorMatrix", false, b => b.kind = BlockKind.Raw),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>("feComponentTransfer", false, b => b.kind = BlockKind.Raw),
  feComposite: new SvgDriver<SVGFECompositeElement>("feComposite", false, b => b.kind = BlockKind.Raw),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>("feConvolveMatrix", false, b => b.kind = BlockKind.Raw),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>("feDiffuseLighting", false, b => b.kind = BlockKind.Raw),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>("feDisplacementMap", false, b => b.kind = BlockKind.Raw),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>("feDistantLight", false, b => b.kind = BlockKind.Raw),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>("feDropShadow", false, b => b.kind = BlockKind.Raw),
  feFlood: new SvgDriver<SVGFEFloodElement>("feFlood", false, b => b.kind = BlockKind.Raw),
  feFuncA: new SvgDriver<SVGFEFuncAElement>("feFuncA", false, b => b.kind = BlockKind.Raw),
  feFuncB: new SvgDriver<SVGFEFuncBElement>("feFuncB", false, b => b.kind = BlockKind.Raw),
  feFuncG: new SvgDriver<SVGFEFuncGElement>("feFuncG", false, b => b.kind = BlockKind.Raw),
  feFuncR: new SvgDriver<SVGFEFuncRElement>("feFuncR", false, b => b.kind = BlockKind.Raw),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>("feGaussianBlur", false, b => b.kind = BlockKind.Raw),
  feImage: new SvgDriver<SVGFEImageElement>("feImage", false, b => b.kind = BlockKind.Raw),
  feMerge: new SvgDriver<SVGFEMergeElement>("feMerge", false, b => b.kind = BlockKind.Raw),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>("feMergeNode", false, b => b.kind = BlockKind.Raw),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>("feMorphology", false, b => b.kind = BlockKind.Raw),
  feOffset: new SvgDriver<SVGFEOffsetElement>("feOffset", false, b => b.kind = BlockKind.Raw),
  fePointLight: new SvgDriver<SVGFEPointLightElement>("fePointLight", false, b => b.kind = BlockKind.Raw),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>("feSpecularLighting", false, b => b.kind = BlockKind.Raw),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>("feSpotLight", false, b => b.kind = BlockKind.Raw),
  feTile: new SvgDriver<SVGFETileElement>("feTile", false, b => b.kind = BlockKind.Raw),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>("feTurbulence", false, b => b.kind = BlockKind.Raw),
  filter: new SvgDriver<SVGFilterElement>("filter", false, b => b.kind = BlockKind.Raw),
  foreignObject: new SvgDriver<SVGForeignObjectElement>("foreignObject", false, b => b.kind = BlockKind.Raw),
  g: new SvgDriver<SVGGElement>("g", false, b => b.kind = BlockKind.Raw),
  image: new SvgDriver<SVGImageElement>("image", false, b => b.kind = BlockKind.Raw),
  line: new SvgDriver<SVGLineElement>("line", false, b => b.kind = BlockKind.Raw),
  linearGradient: new SvgDriver<SVGLinearGradientElement>("linearGradient", false, b => b.kind = BlockKind.Raw),
  marker: new SvgDriver<SVGMarkerElement>("marker", false, b => b.kind = BlockKind.Raw),
  mask: new SvgDriver<SVGMaskElement>("mask", false, b => b.kind = BlockKind.Raw),
  metadata: new SvgDriver<SVGMetadataElement>("metadata", false, b => b.kind = BlockKind.Raw),
  mpath: new SvgDriver<SVGElement>("mpath", false, b => b.kind = BlockKind.Raw),
  path: new SvgDriver<SVGPathElement>("path", false, b => b.kind = BlockKind.Raw),
  pattern: new SvgDriver<SVGPatternElement>("pattern", false, b => b.kind = BlockKind.Raw),
  polygon: new SvgDriver<SVGPolygonElement>("polygon", false, b => b.kind = BlockKind.Raw),
  polyline: new SvgDriver<SVGPolylineElement>("polyline", false, b => b.kind = BlockKind.Raw),
  radialGradient: new SvgDriver<SVGRadialGradientElement>("radialGradient", false, b => b.kind = BlockKind.Raw),
  rect: new SvgDriver<SVGRectElement>("rect", false, b => b.kind = BlockKind.Raw),
  stop: new SvgDriver<SVGStopElement>("stop", false, b => b.kind = BlockKind.Raw),
  switch: new SvgDriver<SVGSwitchElement>("switch", false, b => b.kind = BlockKind.Raw),
  symbol: new SvgDriver<SVGSymbolElement>("symbol", false, b => b.kind = BlockKind.Raw),
  text: new SvgDriver<SVGTextElement>("text", false, b => b.kind = BlockKind.Raw),
  textPath: new SvgDriver<SVGTextPathElement>("textPath", false, b => b.kind = BlockKind.Raw),
  tspan: new SvgDriver<SVGTSpanElement>("tspan", false, b => b.kind = BlockKind.Raw),
  use: new SvgDriver<SVGUseElement>("use", false, b => b.kind = BlockKind.Raw),
  view: new SvgDriver<SVGViewElement>("view", false, b => b.kind = BlockKind.Raw),
}
