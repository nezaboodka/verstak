...
import { Block, Render, StaticBlockFactory, BlockOptions } from '../core/api'
...
const HtmlTags = {
  a: new HtmlBlockFactory<HTMLAnchorElement>('a', true, false),
  abbr: new HtmlBlockFactory<HTMLElement>('abbr', true, false),
  address: new HtmlBlockFactory<HTMLElement>('address', true, false),
  area: new HtmlBlockFactory<HTMLAreaElement>('area', true, false),
  article: new HtmlBlockFactory<HTMLElement>('article', true, false),
  aside: new HtmlBlockFactory<HTMLElement>('aside', true, false),
  audio: new HtmlBlockFactory<HTMLAudioElement>('audio', true, false),
  b: new HtmlBlockFactory<HTMLElement>('b', true, false),
  base: new HtmlBlockFactory<HTMLBaseElement>('base', true, false),
  bdi: new HtmlBlockFactory<HTMLElement>('bdi', true, false),
  bdo: new HtmlBlockFactory<HTMLElement>('bdo', true, false),
  big: new HtmlBlockFactory<HTMLElement>('big', true, false),
  blockquote: new HtmlBlockFactory<HTMLElement>('blockquote', true, false),
  body: new HtmlBlockFactory<HTMLBodyElement>('body', true, false),
  br: new HtmlBlockFactory<HTMLBRElement>('br', true, false),
  button: new HtmlBlockFactory<HTMLButtonElement>('button', true, false),
  canvas: new HtmlBlockFactory<HTMLCanvasElement>('canvas', true, false),
  caption: new HtmlBlockFactory<HTMLTableCaptionElement>('caption', true, false),
  cite: new HtmlBlockFactory<HTMLElement>('cite', true, false),
  code: new HtmlBlockFactory<HTMLElement>('code', true, false),
  col: new HtmlBlockFactory<HTMLTableColElement>('col', true, false),
  colgroup: new HtmlBlockFactory<HTMLTableColElement>('colgroup', true, false),
  data: new HtmlBlockFactory<HTMLDataElement>('data', true, false),
  datalist: new HtmlBlockFactory<HTMLDataListElement>('datalist', true, false),
  dd: new HtmlBlockFactory<HTMLElement>('dd', true, false),
  del: new HtmlBlockFactory<HTMLElement>('del', true, false),
  details: new HtmlBlockFactory<HTMLElement>('details', true, false),
  dfn: new HtmlBlockFactory<HTMLElement>('dfn', true, false),
  div: new HtmlBlockFactory<HTMLDivElement>('div', true, false),
  dl: new HtmlBlockFactory<HTMLDListElement>('dl', true, false),
  dt: new HtmlBlockFactory<HTMLElement>('dt', true, false),
  em: new HtmlBlockFactory<HTMLElement>('em', true, false),
  embed: new HtmlBlockFactory<HTMLEmbedElement>('embed', true, false),
  fieldset: new HtmlBlockFactory<HTMLFieldSetElement>('fieldset', true, false),
  figcaption: new HtmlBlockFactory<HTMLElement>('figcaption', true, false),
  figure: new HtmlBlockFactory<HTMLElement>('figure', true, false),
  footer: new HtmlBlockFactory<HTMLElement>('footer', true, false),
  form: new HtmlBlockFactory<HTMLFormElement>('form', true, false),
  h1: new HtmlBlockFactory<HTMLHeadingElement>('h1', true, false),
  h2: new HtmlBlockFactory<HTMLHeadingElement>('h2', true, false),
  h3: new HtmlBlockFactory<HTMLHeadingElement>('h3', true, false),
  h4: new HtmlBlockFactory<HTMLHeadingElement>('h4', true, false),
  h5: new HtmlBlockFactory<HTMLHeadingElement>('h5', true, false),
  h6: new HtmlBlockFactory<HTMLHeadingElement>('h6', true, false),
  head: new HtmlBlockFactory<HTMLHeadElement>('head', true, false),
  header: new HtmlBlockFactory<HTMLElement>('header', true, false),
  hgroup: new HtmlBlockFactory<HTMLElement>('hgroup', true, false),
  hr: new HtmlBlockFactory<HTMLHRElement>('hr', true, false),
  html: new HtmlBlockFactory<HTMLHtmlElement>('html', true, false),
  i: new HtmlBlockFactory<HTMLElement>('i', true, false),
  iframe: new HtmlBlockFactory<HTMLIFrameElement>('iframe', true, false),
  img: new HtmlBlockFactory<HTMLImageElement>('img', true, false),
  input: new HtmlBlockFactory<HTMLInputElement>('input', true, false),
  ins: new HtmlBlockFactory<HTMLModElement>('ins', true, false),
  kbd: new HtmlBlockFactory<HTMLElement>('kbd', true, false),
  keygen: new HtmlBlockFactory<HTMLElement>('keygen', true, false),
  label: new HtmlBlockFactory<HTMLLabelElement>('label', true, false),
  legend: new HtmlBlockFactory<HTMLLegendElement>('legend', true, false),
  li: new HtmlBlockFactory<HTMLLIElement>('li', true, false),
  link: new HtmlBlockFactory<HTMLLinkElement>('link', true, false),
  main: new HtmlBlockFactory<HTMLElement>('main', true, false),
  map: new HtmlBlockFactory<HTMLMapElement>('map', true, false),
  mark: new HtmlBlockFactory<HTMLElement>('mark', true, false),
  menu: new HtmlBlockFactory<HTMLElement>('menu', true, false),
  menuitem: new HtmlBlockFactory<HTMLElement>('menuitem', true, false),
  meta: new HtmlBlockFactory<HTMLMetaElement>('meta', true, false),
  meter: new HtmlBlockFactory<HTMLElement>('meter', true, false),
  nav: new HtmlBlockFactory<HTMLElement>('nav', true, false),
  noindex: new HtmlBlockFactory<HTMLElement>('noindex', true, false),
  noscript: new HtmlBlockFactory<HTMLElement>('noscript', true, false),
  object: new HtmlBlockFactory<HTMLObjectElement>('object', true, false),
  ol: new HtmlBlockFactory<HTMLOListElement>('ol', true, false),
  optgroup: new HtmlBlockFactory<HTMLOptGroupElement>('optgroup', true, false),
  option: new HtmlBlockFactory<HTMLOptionElement>('option', true, false),
  output: new HtmlBlockFactory<HTMLElement>('output', true, false),
  p: new HtmlBlockFactory<HTMLParagraphElement>('p', true, false),
  param: new HtmlBlockFactory<HTMLElement>('param', true, false),
  picture: new HtmlBlockFactory<HTMLElement>('picture', true, false),
  pre: new HtmlBlockFactory<HTMLPreElement>('pre', true, false),
  progress: new HtmlBlockFactory<HTMLProgressElement>('progress', true, false),
  q: new HtmlBlockFactory<HTMLQuoteElement>('q', true, false),
  rp: new HtmlBlockFactory<HTMLElement>('rp', true, false),
  rt: new HtmlBlockFactory<HTMLElement>('rt', true, false),
  ruby: new HtmlBlockFactory<HTMLElement>('ruby', true, false),
  s: new HtmlBlockFactory<HTMLElement>('s', true, false),
  samp: new HtmlBlockFactory<HTMLElement>('samp', true, false),
  script: new HtmlBlockFactory<HTMLScriptElement>('script', true, false),
  section: new HtmlBlockFactory<HTMLElement>('section', true, false),
  select: new HtmlBlockFactory<HTMLSelectElement>('select', true, false),
  small: new HtmlBlockFactory<HTMLElement>('small', true, false),
  source: new HtmlBlockFactory<HTMLSourceElement>('source', true, false),
  span: new HtmlBlockFactory<HTMLSpanElement>('span', true, false),
  strong: new HtmlBlockFactory<HTMLElement>('strong', true, false),
  style: new HtmlBlockFactory<HTMLStyleElement>('style', true, false),
  sub: new HtmlBlockFactory<HTMLElement>('sub', true, false),
  summary: new HtmlBlockFactory<HTMLElement>('summary', true, false),
  sup: new HtmlBlockFactory<HTMLElement>('sup', true, false),
  table: new HtmlBlockFactory<HTMLTableElement>('table', true, false),
  template: new HtmlBlockFactory<HTMLTemplateElement>('template', true, false),
  tbody: new HtmlBlockFactory<HTMLTableSectionElement>('tbody', true, false),
  td: new HtmlBlockFactory<HTMLTableCellElement>('td', true, false),
  textarea: new HtmlBlockFactory<HTMLTextAreaElement>('textarea', true, false),
  tfoot: new HtmlBlockFactory<HTMLTableSectionElement>('tfoot', true, false),
  th: new HtmlBlockFactory<HTMLTableCellElement>('th', true, false),
  thead: new HtmlBlockFactory<HTMLTableSectionElement>('thead', true, false),
  time: new HtmlBlockFactory<HTMLElement>('time', true, false),
  title: new HtmlBlockFactory<HTMLTitleElement>('title', true, false),
  tr: new HtmlBlockFactory<HTMLTableRowElement>('tr', true, false),
  track: new HtmlBlockFactory<HTMLTrackElement>('track', true, false),
  u: new HtmlBlockFactory<HTMLElement>('u', true, false),
  ul: new HtmlBlockFactory<HTMLUListElement>('ul', true, false),
  var: new HtmlBlockFactory<HTMLElement>('var', true, false),
  video: new HtmlBlockFactory<HTMLVideoElement>('video', true, false),
  wbr: new HtmlBlockFactory<HTMLElement>('wbr', true, false),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', true, false),
}

const SvgTags = {
  svg: new SvgBlockFactory<SVGSVGElement>('svg', true, false),
  a: new SvgBlockFactory<SVGAElement>('a', true, false),
  animate: new SvgBlockFactory<SVGAnimateElement>('animate', true, false),
  animateMotion: new SvgBlockFactory<SVGAnimateMotionElement>('animateMotion', true, false),
  animateTransform: new SvgBlockFactory<SVGAnimateTransformElement>('animateTransform', true, false),
  circle: new SvgBlockFactory<SVGCircleElement>('circle', true, false),
  clipPath: new SvgBlockFactory<SVGClipPathElement>('clipPath', true, false),
  defs: new SvgBlockFactory<SVGDefsElement>('defs', true, false),
  desc: new SvgBlockFactory<SVGDescElement>('desc', true, false),
  ellipse: new SvgBlockFactory<SVGEllipseElement>('ellipse', true, false),
  feBlend: new SvgBlockFactory<SVGFEBlendElement>('feBlend', true, false),
  feColorMatrix: new SvgBlockFactory<SVGFEColorMatrixElement>('feColorMatrix', true, false),
  feComponentTransfer: new SvgBlockFactory<SVGFEComponentTransferElement>('feComponentTransfer', true, false),
  feComposite: new SvgBlockFactory<SVGFECompositeElement>('feComposite', true, false),
  feConvolveMatrix: new SvgBlockFactory<SVGFEConvolveMatrixElement>('feConvolveMatrix', true, false),
  feDiffuseLighting: new SvgBlockFactory<SVGFEDiffuseLightingElement>('feDiffuseLighting', true, false),
  feDisplacementMap: new SvgBlockFactory<SVGFEDisplacementMapElement>('feDisplacementMap', true, false),
  feDistantLight: new SvgBlockFactory<SVGFEDistantLightElement>('feDistantLight', true, false),
  feDropShadow: new SvgBlockFactory<SVGFEDropShadowElement>('feDropShadow', true, false),
  feFlood: new SvgBlockFactory<SVGFEFloodElement>('feFlood', true, false),
  feFuncA: new SvgBlockFactory<SVGFEFuncAElement>('feFuncA', true, false),
  feFuncB: new SvgBlockFactory<SVGFEFuncBElement>('feFuncB', true, false),
  feFuncG: new SvgBlockFactory<SVGFEFuncGElement>('feFuncG', true, false),
  feFuncR: new SvgBlockFactory<SVGFEFuncRElement>('feFuncR', true, false),
  feGaussianBlur: new SvgBlockFactory<SVGFEGaussianBlurElement>('feGaussianBlur', true, false),
  feImage: new SvgBlockFactory<SVGFEImageElement>('feImage', true, false),
  feMerge: new SvgBlockFactory<SVGFEMergeElement>('feMerge', true, false),
  feMergeNode: new SvgBlockFactory<SVGFEMergeNodeElement>('feMergeNode', true, false),
  feMorphology: new SvgBlockFactory<SVGFEMorphologyElement>('feMorphology', true, false),
  feOffset: new SvgBlockFactory<SVGFEOffsetElement>('feOffset', true, false),
  fePointLight: new SvgBlockFactory<SVGFEPointLightElement>('fePointLight', true, false),
  feSpecularLighting: new SvgBlockFactory<SVGFESpecularLightingElement>('feSpecularLighting', true, false),
  feSpotLight: new SvgBlockFactory<SVGFESpotLightElement>('feSpotLight', true, false),
  feTile: new SvgBlockFactory<SVGFETileElement>('feTile', true, false),
  feTurbulence: new SvgBlockFactory<SVGFETurbulenceElement>('feTurbulence', true, false),
  filter: new SvgBlockFactory<SVGFilterElement>('filter', true, false),
  foreignObject: new SvgBlockFactory<SVGForeignObjectElement>('foreignObject', true, false),
  g: new SvgBlockFactory<SVGGElement>('g', true, false),
  image: new SvgBlockFactory<SVGImageElement>('image', true, false),
  line: new SvgBlockFactory<SVGLineElement>('line', true, false),
  linearGradient: new SvgBlockFactory<SVGLinearGradientElement>('linearGradient', true, false),
  marker: new SvgBlockFactory<SVGMarkerElement>('marker', true, false),
  mask: new SvgBlockFactory<SVGMaskElement>('mask', true, false),
  metadata: new SvgBlockFactory<SVGMetadataElement>('metadata', true, false),
  mpath: new SvgBlockFactory<SVGElement>('mpath', true, false),
  path: new SvgBlockFactory<SVGPathElement>('path', true, false),
  pattern: new SvgBlockFactory<SVGPatternElement>('pattern', true, false),
  polygon: new SvgBlockFactory<SVGPolygonElement>('polygon', true, false),
  polyline: new SvgBlockFactory<SVGPolylineElement>('polyline', true, false),
  radialGradient: new SvgBlockFactory<SVGRadialGradientElement>('radialGradient', true, false),
  rect: new SvgBlockFactory<SVGRectElement>('rect', true, false),
  stop: new SvgBlockFactory<SVGStopElement>('stop', true, false),
  switch: new SvgBlockFactory<SVGSwitchElement>('switch', true, false),
  symbol: new SvgBlockFactory<SVGSymbolElement>('symbol', true, false),
  text: new SvgBlockFactory<SVGTextElement>('text', true, false),
  textPath: new SvgBlockFactory<SVGTextPathElement>('textPath', true, false),
  tspan: new SvgBlockFactory<SVGTSpanElement>('tspan', true, false),
  use: new SvgBlockFactory<SVGUseElement>('use', true, false),
  view: new SvgBlockFactory<SVGViewElement>('view', true, false),
}
