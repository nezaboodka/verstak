...
export function HtmlBody(body?: BlockBody<HTMLElement>, base?: BlockBody<HTMLElement>): VBlock<HTMLElement> {
  const driver = new StaticDriver(global.document.body, "HtmlBody", LayoutKind.Ribbon)
...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>("a", LayoutKind.Ribbon),
  abbr: new HtmlDriver<HTMLElement>("abbr", LayoutKind.Ribbon),
  address: new HtmlDriver<HTMLElement>("address", LayoutKind.Ribbon),
  area: new HtmlDriver<HTMLAreaElement>("area", LayoutKind.Ribbon),
  article: new HtmlDriver<HTMLElement>("article", LayoutKind.Ribbon),
  aside: new HtmlDriver<HTMLElement>("aside", LayoutKind.Ribbon),
  audio: new HtmlDriver<HTMLAudioElement>("audio", LayoutKind.Ribbon),
  b: new HtmlDriver<HTMLElement>("b", LayoutKind.Ribbon),
  base: new HtmlDriver<HTMLBaseElement>("base", LayoutKind.Ribbon),
  bdi: new HtmlDriver<HTMLElement>("bdi", LayoutKind.Ribbon),
  bdo: new HtmlDriver<HTMLElement>("bdo", LayoutKind.Ribbon),
  big: new HtmlDriver<HTMLElement>("big", LayoutKind.Ribbon),
  blockquote: new HtmlDriver<HTMLElement>("blockquote", LayoutKind.Ribbon),
  body: new HtmlDriver<HTMLBodyElement>("body", LayoutKind.Ribbon),
  br: new HtmlDriver<HTMLBRElement>("br", LayoutKind.Ribbon),
  button: new HtmlDriver<HTMLButtonElement>("button", LayoutKind.Ribbon),
  canvas: new HtmlDriver<HTMLCanvasElement>("canvas", LayoutKind.Ribbon),
  caption: new HtmlDriver<HTMLTableCaptionElement>("caption", LayoutKind.Ribbon),
  cite: new HtmlDriver<HTMLElement>("cite", LayoutKind.Ribbon),
  code: new HtmlDriver<HTMLElement>("code", LayoutKind.Ribbon),
  col: new HtmlDriver<HTMLTableColElement>("col", LayoutKind.Ribbon),
  colgroup: new HtmlDriver<HTMLTableColElement>("colgroup", LayoutKind.Ribbon),
  data: new HtmlDriver<HTMLDataElement>("data", LayoutKind.Ribbon),
  datalist: new HtmlDriver<HTMLDataListElement>("datalist", LayoutKind.Ribbon),
  dd: new HtmlDriver<HTMLElement>("dd", LayoutKind.Ribbon),
  del: new HtmlDriver<HTMLElement>("del", LayoutKind.Ribbon),
  details: new HtmlDriver<HTMLElement>("details", LayoutKind.Ribbon),
  dfn: new HtmlDriver<HTMLElement>("dfn", LayoutKind.Ribbon),
  div: new HtmlDriver<HTMLDivElement>("div", LayoutKind.Ribbon),
  dl: new HtmlDriver<HTMLDListElement>("dl", LayoutKind.Ribbon),
  dt: new HtmlDriver<HTMLElement>("dt", LayoutKind.Ribbon),
  em: new HtmlDriver<HTMLElement>("em", LayoutKind.Ribbon),
  embed: new HtmlDriver<HTMLEmbedElement>("embed", LayoutKind.Ribbon),
  fieldset: new HtmlDriver<HTMLFieldSetElement>("fieldset", LayoutKind.Ribbon),
  figcaption: new HtmlDriver<HTMLElement>("figcaption", LayoutKind.Ribbon),
  figure: new HtmlDriver<HTMLElement>("figure", LayoutKind.Ribbon),
  footer: new HtmlDriver<HTMLElement>("footer", LayoutKind.Ribbon),
  form: new HtmlDriver<HTMLFormElement>("form", LayoutKind.Ribbon),
  h1: new HtmlDriver<HTMLHeadingElement>("h1", LayoutKind.Ribbon),
  h2: new HtmlDriver<HTMLHeadingElement>("h2", LayoutKind.Ribbon),
  h3: new HtmlDriver<HTMLHeadingElement>("h3", LayoutKind.Ribbon),
  h4: new HtmlDriver<HTMLHeadingElement>("h4", LayoutKind.Ribbon),
  h5: new HtmlDriver<HTMLHeadingElement>("h5", LayoutKind.Ribbon),
  h6: new HtmlDriver<HTMLHeadingElement>("h6", LayoutKind.Ribbon),
  head: new HtmlDriver<HTMLHeadElement>("head", LayoutKind.Ribbon),
  header: new HtmlDriver<HTMLElement>("header", LayoutKind.Ribbon),
  hgroup: new HtmlDriver<HTMLElement>("hgroup", LayoutKind.Ribbon),
  hr: new HtmlDriver<HTMLHRElement>("hr", LayoutKind.Ribbon),
  html: new HtmlDriver<HTMLHtmlElement>("html", LayoutKind.Ribbon),
  i: new HtmlDriver<HTMLElement>("i", LayoutKind.Ribbon),
  iframe: new HtmlDriver<HTMLIFrameElement>("iframe", LayoutKind.Ribbon),
  img: new HtmlDriver<HTMLImageElement>("img", LayoutKind.Ribbon),
  input: new HtmlDriver<HTMLInputElement>("input", LayoutKind.Ribbon),
  ins: new HtmlDriver<HTMLModElement>("ins", LayoutKind.Ribbon),
  kbd: new HtmlDriver<HTMLElement>("kbd", LayoutKind.Ribbon),
  keygen: new HtmlDriver<HTMLElement>("keygen", LayoutKind.Ribbon),
  label: new HtmlDriver<HTMLLabelElement>("label", LayoutKind.Ribbon),
  legend: new HtmlDriver<HTMLLegendElement>("legend", LayoutKind.Ribbon),
  li: new HtmlDriver<HTMLLIElement>("li", LayoutKind.Ribbon),
  link: new HtmlDriver<HTMLLinkElement>("link", LayoutKind.Ribbon),
  main: new HtmlDriver<HTMLElement>("main", LayoutKind.Ribbon),
  map: new HtmlDriver<HTMLMapElement>("map", LayoutKind.Ribbon),
  mark: new HtmlDriver<HTMLElement>("mark", LayoutKind.Ribbon),
  menu: new HtmlDriver<HTMLElement>("menu", LayoutKind.Ribbon),
  menuitem: new HtmlDriver<HTMLElement>("menuitem", LayoutKind.Ribbon),
  meta: new HtmlDriver<HTMLMetaElement>("meta", LayoutKind.Ribbon),
  meter: new HtmlDriver<HTMLElement>("meter", LayoutKind.Ribbon),
  nav: new HtmlDriver<HTMLElement>("nav", LayoutKind.Ribbon),
  noindex: new HtmlDriver<HTMLElement>("noindex", LayoutKind.Ribbon),
  noscript: new HtmlDriver<HTMLElement>("noscript", LayoutKind.Ribbon),
  object: new HtmlDriver<HTMLObjectElement>("object", LayoutKind.Ribbon),
  ol: new HtmlDriver<HTMLOListElement>("ol", LayoutKind.Ribbon),
  optgroup: new HtmlDriver<HTMLOptGroupElement>("optgroup", LayoutKind.Ribbon),
  option: new HtmlDriver<HTMLOptionElement>("option", LayoutKind.Ribbon),
  output: new HtmlDriver<HTMLElement>("output", LayoutKind.Ribbon),
  p: new HtmlDriver<HTMLParagraphElement>("p", LayoutKind.Ribbon),
  param: new HtmlDriver<HTMLElement>("param", LayoutKind.Ribbon),
  picture: new HtmlDriver<HTMLElement>("picture", LayoutKind.Ribbon),
  pre: new HtmlDriver<HTMLPreElement>("pre", LayoutKind.Ribbon),
  progress: new HtmlDriver<HTMLProgressElement>("progress", LayoutKind.Ribbon),
  q: new HtmlDriver<HTMLQuoteElement>("q", LayoutKind.Ribbon),
  rp: new HtmlDriver<HTMLElement>("rp", LayoutKind.Ribbon),
  rt: new HtmlDriver<HTMLElement>("rt", LayoutKind.Ribbon),
  ruby: new HtmlDriver<HTMLElement>("ruby", LayoutKind.Ribbon),
  s: new HtmlDriver<HTMLElement>("s", LayoutKind.Ribbon),
  samp: new HtmlDriver<HTMLElement>("samp", LayoutKind.Ribbon),
  script: new HtmlDriver<HTMLScriptElement>("script", LayoutKind.Ribbon),
  section: new HtmlDriver<HTMLElement>("section", LayoutKind.Ribbon),
  select: new HtmlDriver<HTMLSelectElement>("select", LayoutKind.Ribbon),
  small: new HtmlDriver<HTMLElement>("small", LayoutKind.Ribbon),
  source: new HtmlDriver<HTMLSourceElement>("source", LayoutKind.Ribbon),
  span: new HtmlDriver<HTMLSpanElement>("span", LayoutKind.Ribbon),
  strong: new HtmlDriver<HTMLElement>("strong", LayoutKind.Ribbon),
  style: new HtmlDriver<HTMLStyleElement>("style", LayoutKind.Ribbon),
  sub: new HtmlDriver<HTMLElement>("sub", LayoutKind.Ribbon),
  summary: new HtmlDriver<HTMLElement>("summary", LayoutKind.Ribbon),
  sup: new HtmlDriver<HTMLElement>("sup", LayoutKind.Ribbon),
  table: new HtmlDriver<HTMLTableElement>("table", LayoutKind.Ribbon),
  template: new HtmlDriver<HTMLTemplateElement>("template", LayoutKind.Ribbon),
  tbody: new HtmlDriver<HTMLTableSectionElement>("tbody", LayoutKind.Ribbon),
  td: new HtmlDriver<HTMLTableCellElement>("td", LayoutKind.Ribbon),
  textarea: new HtmlDriver<HTMLTextAreaElement>("textarea", LayoutKind.Ribbon),
  tfoot: new HtmlDriver<HTMLTableSectionElement>("tfoot", LayoutKind.Ribbon),
  th: new HtmlDriver<HTMLTableCellElement>("th", LayoutKind.Ribbon),
  thead: new HtmlDriver<HTMLTableSectionElement>("thead", LayoutKind.Ribbon),
  time: new HtmlDriver<HTMLElement>("time", LayoutKind.Ribbon),
  title: new HtmlDriver<HTMLTitleElement>("title", LayoutKind.Ribbon),
  tr: new HtmlDriver<HTMLTableRowElement>("tr", LayoutKind.Ribbon),
  track: new HtmlDriver<HTMLTrackElement>("track", LayoutKind.Ribbon),
  u: new HtmlDriver<HTMLElement>("u", LayoutKind.Ribbon),
  ul: new HtmlDriver<HTMLUListElement>("ul", LayoutKind.Ribbon),
  var: new HtmlDriver<HTMLElement>("var", LayoutKind.Ribbon),
  video: new HtmlDriver<HTMLVideoElement>("video", LayoutKind.Ribbon),
  wbr: new HtmlDriver<HTMLElement>("wbr", LayoutKind.Ribbon),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', LayoutKind.Block),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>("svg", LayoutKind.Ribbon),
  a: new SvgDriver<SVGAElement>("a", LayoutKind.Ribbon),
  animate: new SvgDriver<SVGAnimateElement>("animate", LayoutKind.Ribbon),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>("animateMotion", LayoutKind.Ribbon),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>("animateTransform", LayoutKind.Ribbon),
  circle: new SvgDriver<SVGCircleElement>("circle", LayoutKind.Ribbon),
  clipPath: new SvgDriver<SVGClipPathElement>("clipPath", LayoutKind.Ribbon),
  defs: new SvgDriver<SVGDefsElement>("defs", LayoutKind.Ribbon),
  desc: new SvgDriver<SVGDescElement>("desc", LayoutKind.Ribbon),
  ellipse: new SvgDriver<SVGEllipseElement>("ellipse", LayoutKind.Ribbon),
  feBlend: new SvgDriver<SVGFEBlendElement>("feBlend", LayoutKind.Ribbon),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>("feColorMatrix", LayoutKind.Ribbon),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>("feComponentTransfer", LayoutKind.Ribbon),
  feComposite: new SvgDriver<SVGFECompositeElement>("feComposite", LayoutKind.Ribbon),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>("feConvolveMatrix", LayoutKind.Ribbon),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>("feDiffuseLighting", LayoutKind.Ribbon),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>("feDisplacementMap", LayoutKind.Ribbon),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>("feDistantLight", LayoutKind.Ribbon),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>("feDropShadow", LayoutKind.Ribbon),
  feFlood: new SvgDriver<SVGFEFloodElement>("feFlood", LayoutKind.Ribbon),
  feFuncA: new SvgDriver<SVGFEFuncAElement>("feFuncA", LayoutKind.Ribbon),
  feFuncB: new SvgDriver<SVGFEFuncBElement>("feFuncB", LayoutKind.Ribbon),
  feFuncG: new SvgDriver<SVGFEFuncGElement>("feFuncG", LayoutKind.Ribbon),
  feFuncR: new SvgDriver<SVGFEFuncRElement>("feFuncR", LayoutKind.Ribbon),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>("feGaussianBlur", LayoutKind.Ribbon),
  feImage: new SvgDriver<SVGFEImageElement>("feImage", LayoutKind.Ribbon),
  feMerge: new SvgDriver<SVGFEMergeElement>("feMerge", LayoutKind.Ribbon),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>("feMergeNode", LayoutKind.Ribbon),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>("feMorphology", LayoutKind.Ribbon),
  feOffset: new SvgDriver<SVGFEOffsetElement>("feOffset", LayoutKind.Ribbon),
  fePointLight: new SvgDriver<SVGFEPointLightElement>("fePointLight", LayoutKind.Ribbon),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>("feSpecularLighting", LayoutKind.Ribbon),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>("feSpotLight", LayoutKind.Ribbon),
  feTile: new SvgDriver<SVGFETileElement>("feTile", LayoutKind.Ribbon),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>("feTurbulence", LayoutKind.Ribbon),
  filter: new SvgDriver<SVGFilterElement>("filter", LayoutKind.Ribbon),
  foreignObject: new SvgDriver<SVGForeignObjectElement>("foreignObject", LayoutKind.Ribbon),
  g: new SvgDriver<SVGGElement>("g", LayoutKind.Ribbon),
  image: new SvgDriver<SVGImageElement>("image", LayoutKind.Ribbon),
  line: new SvgDriver<SVGLineElement>("line", LayoutKind.Ribbon),
  linearGradient: new SvgDriver<SVGLinearGradientElement>("linearGradient", LayoutKind.Ribbon),
  marker: new SvgDriver<SVGMarkerElement>("marker", LayoutKind.Ribbon),
  mask: new SvgDriver<SVGMaskElement>("mask", LayoutKind.Ribbon),
  metadata: new SvgDriver<SVGMetadataElement>("metadata", LayoutKind.Ribbon),
  mpath: new SvgDriver<SVGElement>("mpath", LayoutKind.Ribbon),
  path: new SvgDriver<SVGPathElement>("path", LayoutKind.Ribbon),
  pattern: new SvgDriver<SVGPatternElement>("pattern", LayoutKind.Ribbon),
  polygon: new SvgDriver<SVGPolygonElement>("polygon", LayoutKind.Ribbon),
  polyline: new SvgDriver<SVGPolylineElement>("polyline", LayoutKind.Ribbon),
  radialGradient: new SvgDriver<SVGRadialGradientElement>("radialGradient", LayoutKind.Ribbon),
  rect: new SvgDriver<SVGRectElement>("rect", LayoutKind.Ribbon),
  stop: new SvgDriver<SVGStopElement>("stop", LayoutKind.Ribbon),
  switch: new SvgDriver<SVGSwitchElement>("switch", LayoutKind.Ribbon),
  symbol: new SvgDriver<SVGSymbolElement>("symbol", LayoutKind.Ribbon),
  text: new SvgDriver<SVGTextElement>("text", LayoutKind.Ribbon),
  textPath: new SvgDriver<SVGTextPathElement>("textPath", LayoutKind.Ribbon),
  tspan: new SvgDriver<SVGTSpanElement>("tspan", LayoutKind.Ribbon),
  use: new SvgDriver<SVGUseElement>("use", LayoutKind.Ribbon),
  view: new SvgDriver<SVGViewElement>("view", LayoutKind.Ribbon),
}
