...
export function SvgLine<M = unknown, R = void>(name: string, args: BlockArgs<SVGLineElement, M, R> | Render<SVGLineElement, M, R>): VBlock<SVGLineElement, M, R> { return VBlock.claim(name, args instanceof Function ? { render: args } : args, SvgTags.line) }
