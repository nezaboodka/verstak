...
export function HtmlBody(body?: BlockBody<HTMLElement>, base?: BlockBody<HTMLElement>): VBlock<HTMLElement> {
  const driver = new StaticDriver(global.document.body, "HtmlBody", LayoutKind.Bar)
...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>("a", LayoutKind.Bar),
  abbr: new HtmlDriver<HTMLElement>("abbr", LayoutKind.Bar),
  address: new HtmlDriver<HTMLElement>("address", LayoutKind.Bar),
  area: new HtmlDriver<HTMLAreaElement>("area", LayoutKind.Bar),
  article: new HtmlDriver<HTMLElement>("article", LayoutKind.Bar),
  aside: new HtmlDriver<HTMLElement>("aside", LayoutKind.Bar),
  audio: new HtmlDriver<HTMLAudioElement>("audio", LayoutKind.Bar),
  b: new HtmlDriver<HTMLElement>("b", LayoutKind.Bar),
  base: new HtmlDriver<HTMLBaseElement>("base", LayoutKind.Bar),
  bdi: new HtmlDriver<HTMLElement>("bdi", LayoutKind.Bar),
  bdo: new HtmlDriver<HTMLElement>("bdo", LayoutKind.Bar),
  big: new HtmlDriver<HTMLElement>("big", LayoutKind.Bar),
  blockquote: new HtmlDriver<HTMLElement>("blockquote", LayoutKind.Bar),
  body: new HtmlDriver<HTMLBodyElement>("body", LayoutKind.Bar),
  br: new HtmlDriver<HTMLBRElement>("br", LayoutKind.Bar),
  button: new HtmlDriver<HTMLButtonElement>("button", LayoutKind.Bar),
  canvas: new HtmlDriver<HTMLCanvasElement>("canvas", LayoutKind.Bar),
  caption: new HtmlDriver<HTMLTableCaptionElement>("caption", LayoutKind.Bar),
  cite: new HtmlDriver<HTMLElement>("cite", LayoutKind.Bar),
  code: new HtmlDriver<HTMLElement>("code", LayoutKind.Bar),
  col: new HtmlDriver<HTMLTableColElement>("col", LayoutKind.Bar),
  colgroup: new HtmlDriver<HTMLTableColElement>("colgroup", LayoutKind.Bar),
  data: new HtmlDriver<HTMLDataElement>("data", LayoutKind.Bar),
  datalist: new HtmlDriver<HTMLDataListElement>("datalist", LayoutKind.Bar),
  dd: new HtmlDriver<HTMLElement>("dd", LayoutKind.Bar),
  del: new HtmlDriver<HTMLElement>("del", LayoutKind.Bar),
  details: new HtmlDriver<HTMLElement>("details", LayoutKind.Bar),
  dfn: new HtmlDriver<HTMLElement>("dfn", LayoutKind.Bar),
  div: new HtmlDriver<HTMLDivElement>("div", LayoutKind.Bar),
  dl: new HtmlDriver<HTMLDListElement>("dl", LayoutKind.Bar),
  dt: new HtmlDriver<HTMLElement>("dt", LayoutKind.Bar),
  em: new HtmlDriver<HTMLElement>("em", LayoutKind.Bar),
  embed: new HtmlDriver<HTMLEmbedElement>("embed", LayoutKind.Bar),
  fieldset: new HtmlDriver<HTMLFieldSetElement>("fieldset", LayoutKind.Bar),
  figcaption: new HtmlDriver<HTMLElement>("figcaption", LayoutKind.Bar),
  figure: new HtmlDriver<HTMLElement>("figure", LayoutKind.Bar),
  footer: new HtmlDriver<HTMLElement>("footer", LayoutKind.Bar),
  form: new HtmlDriver<HTMLFormElement>("form", LayoutKind.Bar),
  h1: new HtmlDriver<HTMLHeadingElement>("h1", LayoutKind.Bar),
  h2: new HtmlDriver<HTMLHeadingElement>("h2", LayoutKind.Bar),
  h3: new HtmlDriver<HTMLHeadingElement>("h3", LayoutKind.Bar),
  h4: new HtmlDriver<HTMLHeadingElement>("h4", LayoutKind.Bar),
  h5: new HtmlDriver<HTMLHeadingElement>("h5", LayoutKind.Bar),
  h6: new HtmlDriver<HTMLHeadingElement>("h6", LayoutKind.Bar),
  head: new HtmlDriver<HTMLHeadElement>("head", LayoutKind.Bar),
  header: new HtmlDriver<HTMLElement>("header", LayoutKind.Bar),
  hgroup: new HtmlDriver<HTMLElement>("hgroup", LayoutKind.Bar),
  hr: new HtmlDriver<HTMLHRElement>("hr", LayoutKind.Bar),
  html: new HtmlDriver<HTMLHtmlElement>("html", LayoutKind.Bar),
  i: new HtmlDriver<HTMLElement>("i", LayoutKind.Bar),
  iframe: new HtmlDriver<HTMLIFrameElement>("iframe", LayoutKind.Bar),
  img: new HtmlDriver<HTMLImageElement>("img", LayoutKind.Bar),
  input: new HtmlDriver<HTMLInputElement>("input", LayoutKind.Bar),
  ins: new HtmlDriver<HTMLModElement>("ins", LayoutKind.Bar),
  kbd: new HtmlDriver<HTMLElement>("kbd", LayoutKind.Bar),
  keygen: new HtmlDriver<HTMLElement>("keygen", LayoutKind.Bar),
  label: new HtmlDriver<HTMLLabelElement>("label", LayoutKind.Bar),
  legend: new HtmlDriver<HTMLLegendElement>("legend", LayoutKind.Bar),
  li: new HtmlDriver<HTMLLIElement>("li", LayoutKind.Bar),
  link: new HtmlDriver<HTMLLinkElement>("link", LayoutKind.Bar),
  main: new HtmlDriver<HTMLElement>("main", LayoutKind.Bar),
  map: new HtmlDriver<HTMLMapElement>("map", LayoutKind.Bar),
  mark: new HtmlDriver<HTMLElement>("mark", LayoutKind.Bar),
  menu: new HtmlDriver<HTMLElement>("menu", LayoutKind.Bar),
  menuitem: new HtmlDriver<HTMLElement>("menuitem", LayoutKind.Bar),
  meta: new HtmlDriver<HTMLMetaElement>("meta", LayoutKind.Bar),
  meter: new HtmlDriver<HTMLElement>("meter", LayoutKind.Bar),
  nav: new HtmlDriver<HTMLElement>("nav", LayoutKind.Bar),
  noindex: new HtmlDriver<HTMLElement>("noindex", LayoutKind.Bar),
  noscript: new HtmlDriver<HTMLElement>("noscript", LayoutKind.Bar),
  object: new HtmlDriver<HTMLObjectElement>("object", LayoutKind.Bar),
  ol: new HtmlDriver<HTMLOListElement>("ol", LayoutKind.Bar),
  optgroup: new HtmlDriver<HTMLOptGroupElement>("optgroup", LayoutKind.Bar),
  option: new HtmlDriver<HTMLOptionElement>("option", LayoutKind.Bar),
  output: new HtmlDriver<HTMLElement>("output", LayoutKind.Bar),
  p: new HtmlDriver<HTMLParagraphElement>("p", LayoutKind.Bar),
  param: new HtmlDriver<HTMLElement>("param", LayoutKind.Bar),
  picture: new HtmlDriver<HTMLElement>("picture", LayoutKind.Bar),
  pre: new HtmlDriver<HTMLPreElement>("pre", LayoutKind.Bar),
  progress: new HtmlDriver<HTMLProgressElement>("progress", LayoutKind.Bar),
  q: new HtmlDriver<HTMLQuoteElement>("q", LayoutKind.Bar),
  rp: new HtmlDriver<HTMLElement>("rp", LayoutKind.Bar),
  rt: new HtmlDriver<HTMLElement>("rt", LayoutKind.Bar),
  ruby: new HtmlDriver<HTMLElement>("ruby", LayoutKind.Bar),
  s: new HtmlDriver<HTMLElement>("s", LayoutKind.Bar),
  samp: new HtmlDriver<HTMLElement>("samp", LayoutKind.Bar),
  script: new HtmlDriver<HTMLScriptElement>("script", LayoutKind.Bar),
  section: new HtmlDriver<HTMLElement>("section", LayoutKind.Bar),
  select: new HtmlDriver<HTMLSelectElement>("select", LayoutKind.Bar),
  small: new HtmlDriver<HTMLElement>("small", LayoutKind.Bar),
  source: new HtmlDriver<HTMLSourceElement>("source", LayoutKind.Bar),
  span: new HtmlDriver<HTMLSpanElement>("span", LayoutKind.Bar),
  strong: new HtmlDriver<HTMLElement>("strong", LayoutKind.Bar),
  style: new HtmlDriver<HTMLStyleElement>("style", LayoutKind.Bar),
  sub: new HtmlDriver<HTMLElement>("sub", LayoutKind.Bar),
  summary: new HtmlDriver<HTMLElement>("summary", LayoutKind.Bar),
  sup: new HtmlDriver<HTMLElement>("sup", LayoutKind.Bar),
  table: new HtmlDriver<HTMLTableElement>("table", LayoutKind.Bar),
  template: new HtmlDriver<HTMLTemplateElement>("template", LayoutKind.Bar),
  tbody: new HtmlDriver<HTMLTableSectionElement>("tbody", LayoutKind.Bar),
  td: new HtmlDriver<HTMLTableCellElement>("td", LayoutKind.Bar),
  textarea: new HtmlDriver<HTMLTextAreaElement>("textarea", LayoutKind.Bar),
  tfoot: new HtmlDriver<HTMLTableSectionElement>("tfoot", LayoutKind.Bar),
  th: new HtmlDriver<HTMLTableCellElement>("th", LayoutKind.Bar),
  thead: new HtmlDriver<HTMLTableSectionElement>("thead", LayoutKind.Bar),
  time: new HtmlDriver<HTMLElement>("time", LayoutKind.Bar),
  title: new HtmlDriver<HTMLTitleElement>("title", LayoutKind.Bar),
  tr: new HtmlDriver<HTMLTableRowElement>("tr", LayoutKind.Bar),
  track: new HtmlDriver<HTMLTrackElement>("track", LayoutKind.Bar),
  u: new HtmlDriver<HTMLElement>("u", LayoutKind.Bar),
  ul: new HtmlDriver<HTMLUListElement>("ul", LayoutKind.Bar),
  var: new HtmlDriver<HTMLElement>("var", LayoutKind.Bar),
  video: new HtmlDriver<HTMLVideoElement>("video", LayoutKind.Bar),
  wbr: new HtmlDriver<HTMLElement>("wbr", LayoutKind.Bar),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', LayoutKind.Block),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>("svg", LayoutKind.Bar),
  a: new SvgDriver<SVGAElement>("a", LayoutKind.Bar),
  animate: new SvgDriver<SVGAnimateElement>("animate", LayoutKind.Bar),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>("animateMotion", LayoutKind.Bar),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>("animateTransform", LayoutKind.Bar),
  circle: new SvgDriver<SVGCircleElement>("circle", LayoutKind.Bar),
  clipPath: new SvgDriver<SVGClipPathElement>("clipPath", LayoutKind.Bar),
  defs: new SvgDriver<SVGDefsElement>("defs", LayoutKind.Bar),
  desc: new SvgDriver<SVGDescElement>("desc", LayoutKind.Bar),
  ellipse: new SvgDriver<SVGEllipseElement>("ellipse", LayoutKind.Bar),
  feBlend: new SvgDriver<SVGFEBlendElement>("feBlend", LayoutKind.Bar),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>("feColorMatrix", LayoutKind.Bar),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>("feComponentTransfer", LayoutKind.Bar),
  feComposite: new SvgDriver<SVGFECompositeElement>("feComposite", LayoutKind.Bar),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>("feConvolveMatrix", LayoutKind.Bar),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>("feDiffuseLighting", LayoutKind.Bar),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>("feDisplacementMap", LayoutKind.Bar),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>("feDistantLight", LayoutKind.Bar),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>("feDropShadow", LayoutKind.Bar),
  feFlood: new SvgDriver<SVGFEFloodElement>("feFlood", LayoutKind.Bar),
  feFuncA: new SvgDriver<SVGFEFuncAElement>("feFuncA", LayoutKind.Bar),
  feFuncB: new SvgDriver<SVGFEFuncBElement>("feFuncB", LayoutKind.Bar),
  feFuncG: new SvgDriver<SVGFEFuncGElement>("feFuncG", LayoutKind.Bar),
  feFuncR: new SvgDriver<SVGFEFuncRElement>("feFuncR", LayoutKind.Bar),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>("feGaussianBlur", LayoutKind.Bar),
  feImage: new SvgDriver<SVGFEImageElement>("feImage", LayoutKind.Bar),
  feMerge: new SvgDriver<SVGFEMergeElement>("feMerge", LayoutKind.Bar),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>("feMergeNode", LayoutKind.Bar),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>("feMorphology", LayoutKind.Bar),
  feOffset: new SvgDriver<SVGFEOffsetElement>("feOffset", LayoutKind.Bar),
  fePointLight: new SvgDriver<SVGFEPointLightElement>("fePointLight", LayoutKind.Bar),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>("feSpecularLighting", LayoutKind.Bar),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>("feSpotLight", LayoutKind.Bar),
  feTile: new SvgDriver<SVGFETileElement>("feTile", LayoutKind.Bar),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>("feTurbulence", LayoutKind.Bar),
  filter: new SvgDriver<SVGFilterElement>("filter", LayoutKind.Bar),
  foreignObject: new SvgDriver<SVGForeignObjectElement>("foreignObject", LayoutKind.Bar),
  g: new SvgDriver<SVGGElement>("g", LayoutKind.Bar),
  image: new SvgDriver<SVGImageElement>("image", LayoutKind.Bar),
  line: new SvgDriver<SVGLineElement>("line", LayoutKind.Bar),
  linearGradient: new SvgDriver<SVGLinearGradientElement>("linearGradient", LayoutKind.Bar),
  marker: new SvgDriver<SVGMarkerElement>("marker", LayoutKind.Bar),
  mask: new SvgDriver<SVGMaskElement>("mask", LayoutKind.Bar),
  metadata: new SvgDriver<SVGMetadataElement>("metadata", LayoutKind.Bar),
  mpath: new SvgDriver<SVGElement>("mpath", LayoutKind.Bar),
  path: new SvgDriver<SVGPathElement>("path", LayoutKind.Bar),
  pattern: new SvgDriver<SVGPatternElement>("pattern", LayoutKind.Bar),
  polygon: new SvgDriver<SVGPolygonElement>("polygon", LayoutKind.Bar),
  polyline: new SvgDriver<SVGPolylineElement>("polyline", LayoutKind.Bar),
  radialGradient: new SvgDriver<SVGRadialGradientElement>("radialGradient", LayoutKind.Bar),
  rect: new SvgDriver<SVGRectElement>("rect", LayoutKind.Bar),
  stop: new SvgDriver<SVGStopElement>("stop", LayoutKind.Bar),
  switch: new SvgDriver<SVGSwitchElement>("switch", LayoutKind.Bar),
  symbol: new SvgDriver<SVGSymbolElement>("symbol", LayoutKind.Bar),
  text: new SvgDriver<SVGTextElement>("text", LayoutKind.Bar),
  textPath: new SvgDriver<SVGTextPathElement>("textPath", LayoutKind.Bar),
  tspan: new SvgDriver<SVGTSpanElement>("tspan", LayoutKind.Bar),
  use: new SvgDriver<SVGUseElement>("use", LayoutKind.Bar),
  view: new SvgDriver<SVGViewElement>("view", LayoutKind.Bar),
}
