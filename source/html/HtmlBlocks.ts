...
export function HtmlBody(body?: BlockBody<HTMLElement>, base?: BlockBody<HTMLElement>): VBlock<HTMLElement> {
  const driver = new StaticDriver(global.document.body, "HtmlBody", LayoutKind.Band)
...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>("a", LayoutKind.Band),
  abbr: new HtmlDriver<HTMLElement>("abbr", LayoutKind.Band),
  address: new HtmlDriver<HTMLElement>("address", LayoutKind.Band),
  area: new HtmlDriver<HTMLAreaElement>("area", LayoutKind.Band),
  article: new HtmlDriver<HTMLElement>("article", LayoutKind.Band),
  aside: new HtmlDriver<HTMLElement>("aside", LayoutKind.Band),
  audio: new HtmlDriver<HTMLAudioElement>("audio", LayoutKind.Band),
  b: new HtmlDriver<HTMLElement>("b", LayoutKind.Band),
  base: new HtmlDriver<HTMLBaseElement>("base", LayoutKind.Band),
  bdi: new HtmlDriver<HTMLElement>("bdi", LayoutKind.Band),
  bdo: new HtmlDriver<HTMLElement>("bdo", LayoutKind.Band),
  big: new HtmlDriver<HTMLElement>("big", LayoutKind.Band),
  blockquote: new HtmlDriver<HTMLElement>("blockquote", LayoutKind.Band),
  body: new HtmlDriver<HTMLBodyElement>("body", LayoutKind.Band),
  br: new HtmlDriver<HTMLBRElement>("br", LayoutKind.Band),
  button: new HtmlDriver<HTMLButtonElement>("button", LayoutKind.Band),
  canvas: new HtmlDriver<HTMLCanvasElement>("canvas", LayoutKind.Band),
  caption: new HtmlDriver<HTMLTableCaptionElement>("caption", LayoutKind.Band),
  cite: new HtmlDriver<HTMLElement>("cite", LayoutKind.Band),
  code: new HtmlDriver<HTMLElement>("code", LayoutKind.Band),
  col: new HtmlDriver<HTMLTableColElement>("col", LayoutKind.Band),
  colgroup: new HtmlDriver<HTMLTableColElement>("colgroup", LayoutKind.Band),
  data: new HtmlDriver<HTMLDataElement>("data", LayoutKind.Band),
  datalist: new HtmlDriver<HTMLDataListElement>("datalist", LayoutKind.Band),
  dd: new HtmlDriver<HTMLElement>("dd", LayoutKind.Band),
  del: new HtmlDriver<HTMLElement>("del", LayoutKind.Band),
  details: new HtmlDriver<HTMLElement>("details", LayoutKind.Band),
  dfn: new HtmlDriver<HTMLElement>("dfn", LayoutKind.Band),
  div: new HtmlDriver<HTMLDivElement>("div", LayoutKind.Band),
  dl: new HtmlDriver<HTMLDListElement>("dl", LayoutKind.Band),
  dt: new HtmlDriver<HTMLElement>("dt", LayoutKind.Band),
  em: new HtmlDriver<HTMLElement>("em", LayoutKind.Band),
  embed: new HtmlDriver<HTMLEmbedElement>("embed", LayoutKind.Band),
  fieldset: new HtmlDriver<HTMLFieldSetElement>("fieldset", LayoutKind.Band),
  figcaption: new HtmlDriver<HTMLElement>("figcaption", LayoutKind.Band),
  figure: new HtmlDriver<HTMLElement>("figure", LayoutKind.Band),
  footer: new HtmlDriver<HTMLElement>("footer", LayoutKind.Band),
  form: new HtmlDriver<HTMLFormElement>("form", LayoutKind.Band),
  h1: new HtmlDriver<HTMLHeadingElement>("h1", LayoutKind.Band),
  h2: new HtmlDriver<HTMLHeadingElement>("h2", LayoutKind.Band),
  h3: new HtmlDriver<HTMLHeadingElement>("h3", LayoutKind.Band),
  h4: new HtmlDriver<HTMLHeadingElement>("h4", LayoutKind.Band),
  h5: new HtmlDriver<HTMLHeadingElement>("h5", LayoutKind.Band),
  h6: new HtmlDriver<HTMLHeadingElement>("h6", LayoutKind.Band),
  head: new HtmlDriver<HTMLHeadElement>("head", LayoutKind.Band),
  header: new HtmlDriver<HTMLElement>("header", LayoutKind.Band),
  hgroup: new HtmlDriver<HTMLElement>("hgroup", LayoutKind.Band),
  hr: new HtmlDriver<HTMLHRElement>("hr", LayoutKind.Band),
  html: new HtmlDriver<HTMLHtmlElement>("html", LayoutKind.Band),
  i: new HtmlDriver<HTMLElement>("i", LayoutKind.Band),
  iframe: new HtmlDriver<HTMLIFrameElement>("iframe", LayoutKind.Band),
  img: new HtmlDriver<HTMLImageElement>("img", LayoutKind.Band),
  input: new HtmlDriver<HTMLInputElement>("input", LayoutKind.Band),
  ins: new HtmlDriver<HTMLModElement>("ins", LayoutKind.Band),
  kbd: new HtmlDriver<HTMLElement>("kbd", LayoutKind.Band),
  keygen: new HtmlDriver<HTMLElement>("keygen", LayoutKind.Band),
  label: new HtmlDriver<HTMLLabelElement>("label", LayoutKind.Band),
  legend: new HtmlDriver<HTMLLegendElement>("legend", LayoutKind.Band),
  li: new HtmlDriver<HTMLLIElement>("li", LayoutKind.Band),
  link: new HtmlDriver<HTMLLinkElement>("link", LayoutKind.Band),
  main: new HtmlDriver<HTMLElement>("main", LayoutKind.Band),
  map: new HtmlDriver<HTMLMapElement>("map", LayoutKind.Band),
  mark: new HtmlDriver<HTMLElement>("mark", LayoutKind.Band),
  menu: new HtmlDriver<HTMLElement>("menu", LayoutKind.Band),
  menuitem: new HtmlDriver<HTMLElement>("menuitem", LayoutKind.Band),
  meta: new HtmlDriver<HTMLMetaElement>("meta", LayoutKind.Band),
  meter: new HtmlDriver<HTMLElement>("meter", LayoutKind.Band),
  nav: new HtmlDriver<HTMLElement>("nav", LayoutKind.Band),
  noindex: new HtmlDriver<HTMLElement>("noindex", LayoutKind.Band),
  noscript: new HtmlDriver<HTMLElement>("noscript", LayoutKind.Band),
  object: new HtmlDriver<HTMLObjectElement>("object", LayoutKind.Band),
  ol: new HtmlDriver<HTMLOListElement>("ol", LayoutKind.Band),
  optgroup: new HtmlDriver<HTMLOptGroupElement>("optgroup", LayoutKind.Band),
  option: new HtmlDriver<HTMLOptionElement>("option", LayoutKind.Band),
  output: new HtmlDriver<HTMLElement>("output", LayoutKind.Band),
  p: new HtmlDriver<HTMLParagraphElement>("p", LayoutKind.Band),
  param: new HtmlDriver<HTMLElement>("param", LayoutKind.Band),
  picture: new HtmlDriver<HTMLElement>("picture", LayoutKind.Band),
  pre: new HtmlDriver<HTMLPreElement>("pre", LayoutKind.Band),
  progress: new HtmlDriver<HTMLProgressElement>("progress", LayoutKind.Band),
  q: new HtmlDriver<HTMLQuoteElement>("q", LayoutKind.Band),
  rp: new HtmlDriver<HTMLElement>("rp", LayoutKind.Band),
  rt: new HtmlDriver<HTMLElement>("rt", LayoutKind.Band),
  ruby: new HtmlDriver<HTMLElement>("ruby", LayoutKind.Band),
  s: new HtmlDriver<HTMLElement>("s", LayoutKind.Band),
  samp: new HtmlDriver<HTMLElement>("samp", LayoutKind.Band),
  script: new HtmlDriver<HTMLScriptElement>("script", LayoutKind.Band),
  section: new HtmlDriver<HTMLElement>("section", LayoutKind.Band),
  select: new HtmlDriver<HTMLSelectElement>("select", LayoutKind.Band),
  small: new HtmlDriver<HTMLElement>("small", LayoutKind.Band),
  source: new HtmlDriver<HTMLSourceElement>("source", LayoutKind.Band),
  span: new HtmlDriver<HTMLSpanElement>("span", LayoutKind.Band),
  strong: new HtmlDriver<HTMLElement>("strong", LayoutKind.Band),
  style: new HtmlDriver<HTMLStyleElement>("style", LayoutKind.Band),
  sub: new HtmlDriver<HTMLElement>("sub", LayoutKind.Band),
  summary: new HtmlDriver<HTMLElement>("summary", LayoutKind.Band),
  sup: new HtmlDriver<HTMLElement>("sup", LayoutKind.Band),
  table: new HtmlDriver<HTMLTableElement>("table", LayoutKind.Band),
  template: new HtmlDriver<HTMLTemplateElement>("template", LayoutKind.Band),
  tbody: new HtmlDriver<HTMLTableSectionElement>("tbody", LayoutKind.Band),
  td: new HtmlDriver<HTMLTableCellElement>("td", LayoutKind.Band),
  textarea: new HtmlDriver<HTMLTextAreaElement>("textarea", LayoutKind.Band),
  tfoot: new HtmlDriver<HTMLTableSectionElement>("tfoot", LayoutKind.Band),
  th: new HtmlDriver<HTMLTableCellElement>("th", LayoutKind.Band),
  thead: new HtmlDriver<HTMLTableSectionElement>("thead", LayoutKind.Band),
  time: new HtmlDriver<HTMLElement>("time", LayoutKind.Band),
  title: new HtmlDriver<HTMLTitleElement>("title", LayoutKind.Band),
  tr: new HtmlDriver<HTMLTableRowElement>("tr", LayoutKind.Band),
  track: new HtmlDriver<HTMLTrackElement>("track", LayoutKind.Band),
  u: new HtmlDriver<HTMLElement>("u", LayoutKind.Band),
  ul: new HtmlDriver<HTMLUListElement>("ul", LayoutKind.Band),
  var: new HtmlDriver<HTMLElement>("var", LayoutKind.Band),
  video: new HtmlDriver<HTMLVideoElement>("video", LayoutKind.Band),
  wbr: new HtmlDriver<HTMLElement>("wbr", LayoutKind.Band),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', LayoutKind.Block),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>("svg", LayoutKind.Band),
  a: new SvgDriver<SVGAElement>("a", LayoutKind.Band),
  animate: new SvgDriver<SVGAnimateElement>("animate", LayoutKind.Band),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>("animateMotion", LayoutKind.Band),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>("animateTransform", LayoutKind.Band),
  circle: new SvgDriver<SVGCircleElement>("circle", LayoutKind.Band),
  clipPath: new SvgDriver<SVGClipPathElement>("clipPath", LayoutKind.Band),
  defs: new SvgDriver<SVGDefsElement>("defs", LayoutKind.Band),
  desc: new SvgDriver<SVGDescElement>("desc", LayoutKind.Band),
  ellipse: new SvgDriver<SVGEllipseElement>("ellipse", LayoutKind.Band),
  feBlend: new SvgDriver<SVGFEBlendElement>("feBlend", LayoutKind.Band),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>("feColorMatrix", LayoutKind.Band),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>("feComponentTransfer", LayoutKind.Band),
  feComposite: new SvgDriver<SVGFECompositeElement>("feComposite", LayoutKind.Band),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>("feConvolveMatrix", LayoutKind.Band),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>("feDiffuseLighting", LayoutKind.Band),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>("feDisplacementMap", LayoutKind.Band),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>("feDistantLight", LayoutKind.Band),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>("feDropShadow", LayoutKind.Band),
  feFlood: new SvgDriver<SVGFEFloodElement>("feFlood", LayoutKind.Band),
  feFuncA: new SvgDriver<SVGFEFuncAElement>("feFuncA", LayoutKind.Band),
  feFuncB: new SvgDriver<SVGFEFuncBElement>("feFuncB", LayoutKind.Band),
  feFuncG: new SvgDriver<SVGFEFuncGElement>("feFuncG", LayoutKind.Band),
  feFuncR: new SvgDriver<SVGFEFuncRElement>("feFuncR", LayoutKind.Band),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>("feGaussianBlur", LayoutKind.Band),
  feImage: new SvgDriver<SVGFEImageElement>("feImage", LayoutKind.Band),
  feMerge: new SvgDriver<SVGFEMergeElement>("feMerge", LayoutKind.Band),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>("feMergeNode", LayoutKind.Band),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>("feMorphology", LayoutKind.Band),
  feOffset: new SvgDriver<SVGFEOffsetElement>("feOffset", LayoutKind.Band),
  fePointLight: new SvgDriver<SVGFEPointLightElement>("fePointLight", LayoutKind.Band),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>("feSpecularLighting", LayoutKind.Band),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>("feSpotLight", LayoutKind.Band),
  feTile: new SvgDriver<SVGFETileElement>("feTile", LayoutKind.Band),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>("feTurbulence", LayoutKind.Band),
  filter: new SvgDriver<SVGFilterElement>("filter", LayoutKind.Band),
  foreignObject: new SvgDriver<SVGForeignObjectElement>("foreignObject", LayoutKind.Band),
  g: new SvgDriver<SVGGElement>("g", LayoutKind.Band),
  image: new SvgDriver<SVGImageElement>("image", LayoutKind.Band),
  line: new SvgDriver<SVGLineElement>("line", LayoutKind.Band),
  linearGradient: new SvgDriver<SVGLinearGradientElement>("linearGradient", LayoutKind.Band),
  marker: new SvgDriver<SVGMarkerElement>("marker", LayoutKind.Band),
  mask: new SvgDriver<SVGMaskElement>("mask", LayoutKind.Band),
  metadata: new SvgDriver<SVGMetadataElement>("metadata", LayoutKind.Band),
  mpath: new SvgDriver<SVGElement>("mpath", LayoutKind.Band),
  path: new SvgDriver<SVGPathElement>("path", LayoutKind.Band),
  pattern: new SvgDriver<SVGPatternElement>("pattern", LayoutKind.Band),
  polygon: new SvgDriver<SVGPolygonElement>("polygon", LayoutKind.Band),
  polyline: new SvgDriver<SVGPolylineElement>("polyline", LayoutKind.Band),
  radialGradient: new SvgDriver<SVGRadialGradientElement>("radialGradient", LayoutKind.Band),
  rect: new SvgDriver<SVGRectElement>("rect", LayoutKind.Band),
  stop: new SvgDriver<SVGStopElement>("stop", LayoutKind.Band),
  switch: new SvgDriver<SVGSwitchElement>("switch", LayoutKind.Band),
  symbol: new SvgDriver<SVGSymbolElement>("symbol", LayoutKind.Band),
  text: new SvgDriver<SVGTextElement>("text", LayoutKind.Band),
  textPath: new SvgDriver<SVGTextPathElement>("textPath", LayoutKind.Band),
  tspan: new SvgDriver<SVGTSpanElement>("tspan", LayoutKind.Band),
  use: new SvgDriver<SVGUseElement>("use", LayoutKind.Band),
  view: new SvgDriver<SVGViewElement>("view", LayoutKind.Band),
}
