...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>("a", false, b => b.childrenLayout = Layout.Section),
  abbr: new HtmlDriver<HTMLElement>("abbr", false, b => b.childrenLayout = Layout.Section),
  address: new HtmlDriver<HTMLElement>("address", false, b => b.childrenLayout = Layout.Section),
  area: new HtmlDriver<HTMLAreaElement>("area", false, b => b.childrenLayout = Layout.Section),
  article: new HtmlDriver<HTMLElement>("article", false, b => b.childrenLayout = Layout.Section),
  aside: new HtmlDriver<HTMLElement>("aside", false, b => b.childrenLayout = Layout.Section),
  audio: new HtmlDriver<HTMLAudioElement>("audio", false, b => b.childrenLayout = Layout.Section),
  b: new HtmlDriver<HTMLElement>("b", false, b => b.childrenLayout = Layout.Section),
  base: new HtmlDriver<HTMLBaseElement>("base", false, b => b.childrenLayout = Layout.Section),
  bdi: new HtmlDriver<HTMLElement>("bdi", false, b => b.childrenLayout = Layout.Section),
  bdo: new HtmlDriver<HTMLElement>("bdo", false, b => b.childrenLayout = Layout.Section),
  big: new HtmlDriver<HTMLElement>("big", false, b => b.childrenLayout = Layout.Section),
  blockquote: new HtmlDriver<HTMLElement>("blockquote", false, b => b.childrenLayout = Layout.Section),
  body: new HtmlDriver<HTMLBodyElement>("body", false, b => b.childrenLayout = Layout.Section),
  br: new HtmlDriver<HTMLBRElement>("br", false, b => b.childrenLayout = Layout.Section),
  button: new HtmlDriver<HTMLButtonElement>("button", false, b => b.childrenLayout = Layout.Section),
  canvas: new HtmlDriver<HTMLCanvasElement>("canvas", false, b => b.childrenLayout = Layout.Section),
  caption: new HtmlDriver<HTMLTableCaptionElement>("caption", false, b => b.childrenLayout = Layout.Section),
  cite: new HtmlDriver<HTMLElement>("cite", false, b => b.childrenLayout = Layout.Section),
  code: new HtmlDriver<HTMLElement>("code", false, b => b.childrenLayout = Layout.Section),
  col: new HtmlDriver<HTMLTableColElement>("col", false, b => b.childrenLayout = Layout.Section),
  colgroup: new HtmlDriver<HTMLTableColElement>("colgroup", false, b => b.childrenLayout = Layout.Section),
  data: new HtmlDriver<HTMLDataElement>("data", false, b => b.childrenLayout = Layout.Section),
  datalist: new HtmlDriver<HTMLDataListElement>("datalist", false, b => b.childrenLayout = Layout.Section),
  dd: new HtmlDriver<HTMLElement>("dd", false, b => b.childrenLayout = Layout.Section),
  del: new HtmlDriver<HTMLElement>("del", false, b => b.childrenLayout = Layout.Section),
  details: new HtmlDriver<HTMLElement>("details", false, b => b.childrenLayout = Layout.Section),
  dfn: new HtmlDriver<HTMLElement>("dfn", false, b => b.childrenLayout = Layout.Section),
  div: new HtmlDriver<HTMLDivElement>("div", false, b => b.childrenLayout = Layout.Section),
  dl: new HtmlDriver<HTMLDListElement>("dl", false, b => b.childrenLayout = Layout.Section),
  dt: new HtmlDriver<HTMLElement>("dt", false, b => b.childrenLayout = Layout.Section),
  em: new HtmlDriver<HTMLElement>("em", false, b => b.childrenLayout = Layout.Section),
  embed: new HtmlDriver<HTMLEmbedElement>("embed", false, b => b.childrenLayout = Layout.Section),
  fieldset: new HtmlDriver<HTMLFieldSetElement>("fieldset", false, b => b.childrenLayout = Layout.Section),
  figcaption: new HtmlDriver<HTMLElement>("figcaption", false, b => b.childrenLayout = Layout.Section),
  figure: new HtmlDriver<HTMLElement>("figure", false, b => b.childrenLayout = Layout.Section),
  footer: new HtmlDriver<HTMLElement>("footer", false, b => b.childrenLayout = Layout.Section),
  form: new HtmlDriver<HTMLFormElement>("form", false, b => b.childrenLayout = Layout.Section),
  h1: new HtmlDriver<HTMLHeadingElement>("h1", false, b => b.childrenLayout = Layout.Section),
  h2: new HtmlDriver<HTMLHeadingElement>("h2", false, b => b.childrenLayout = Layout.Section),
  h3: new HtmlDriver<HTMLHeadingElement>("h3", false, b => b.childrenLayout = Layout.Section),
  h4: new HtmlDriver<HTMLHeadingElement>("h4", false, b => b.childrenLayout = Layout.Section),
  h5: new HtmlDriver<HTMLHeadingElement>("h5", false, b => b.childrenLayout = Layout.Section),
  h6: new HtmlDriver<HTMLHeadingElement>("h6", false, b => b.childrenLayout = Layout.Section),
  head: new HtmlDriver<HTMLHeadElement>("head", false, b => b.childrenLayout = Layout.Section),
  header: new HtmlDriver<HTMLElement>("header", false, b => b.childrenLayout = Layout.Section),
  hgroup: new HtmlDriver<HTMLElement>("hgroup", false, b => b.childrenLayout = Layout.Section),
  hr: new HtmlDriver<HTMLHRElement>("hr", false, b => b.childrenLayout = Layout.Section),
  html: new HtmlDriver<HTMLHtmlElement>("html", false, b => b.childrenLayout = Layout.Section),
  i: new HtmlDriver<HTMLElement>("i", false, b => b.childrenLayout = Layout.Section),
  iframe: new HtmlDriver<HTMLIFrameElement>("iframe", false, b => b.childrenLayout = Layout.Section),
  img: new HtmlDriver<HTMLImageElement>("img", false, b => b.childrenLayout = Layout.Section),
  input: new HtmlDriver<HTMLInputElement>("input", false, b => b.childrenLayout = Layout.Section),
  ins: new HtmlDriver<HTMLModElement>("ins", false, b => b.childrenLayout = Layout.Section),
  kbd: new HtmlDriver<HTMLElement>("kbd", false, b => b.childrenLayout = Layout.Section),
  keygen: new HtmlDriver<HTMLElement>("keygen", false, b => b.childrenLayout = Layout.Section),
  label: new HtmlDriver<HTMLLabelElement>("label", false, b => b.childrenLayout = Layout.Section),
  legend: new HtmlDriver<HTMLLegendElement>("legend", false, b => b.childrenLayout = Layout.Section),
  li: new HtmlDriver<HTMLLIElement>("li", false, b => b.childrenLayout = Layout.Section),
  link: new HtmlDriver<HTMLLinkElement>("link", false, b => b.childrenLayout = Layout.Section),
  main: new HtmlDriver<HTMLElement>("main", false, b => b.childrenLayout = Layout.Section),
  map: new HtmlDriver<HTMLMapElement>("map", false, b => b.childrenLayout = Layout.Section),
  mark: new HtmlDriver<HTMLElement>("mark", false, b => b.childrenLayout = Layout.Section),
  menu: new HtmlDriver<HTMLElement>("menu", false, b => b.childrenLayout = Layout.Section),
  menuitem: new HtmlDriver<HTMLElement>("menuitem", false, b => b.childrenLayout = Layout.Section),
  meta: new HtmlDriver<HTMLMetaElement>("meta", false, b => b.childrenLayout = Layout.Section),
  meter: new HtmlDriver<HTMLElement>("meter", false, b => b.childrenLayout = Layout.Section),
  nav: new HtmlDriver<HTMLElement>("nav", false, b => b.childrenLayout = Layout.Section),
  noindex: new HtmlDriver<HTMLElement>("noindex", false, b => b.childrenLayout = Layout.Section),
  noscript: new HtmlDriver<HTMLElement>("noscript", false, b => b.childrenLayout = Layout.Section),
  object: new HtmlDriver<HTMLObjectElement>("object", false, b => b.childrenLayout = Layout.Section),
  ol: new HtmlDriver<HTMLOListElement>("ol", false, b => b.childrenLayout = Layout.Section),
  optgroup: new HtmlDriver<HTMLOptGroupElement>("optgroup", false, b => b.childrenLayout = Layout.Section),
  option: new HtmlDriver<HTMLOptionElement>("option", false, b => b.childrenLayout = Layout.Section),
  output: new HtmlDriver<HTMLElement>("output", false, b => b.childrenLayout = Layout.Section),
  p: new HtmlDriver<HTMLParagraphElement>("p", false, b => b.childrenLayout = Layout.Section),
  param: new HtmlDriver<HTMLElement>("param", false, b => b.childrenLayout = Layout.Section),
  picture: new HtmlDriver<HTMLElement>("picture", false, b => b.childrenLayout = Layout.Section),
  pre: new HtmlDriver<HTMLPreElement>("pre", false, b => b.childrenLayout = Layout.Section),
  progress: new HtmlDriver<HTMLProgressElement>("progress", false, b => b.childrenLayout = Layout.Section),
  q: new HtmlDriver<HTMLQuoteElement>("q", false, b => b.childrenLayout = Layout.Section),
  rp: new HtmlDriver<HTMLElement>("rp", false, b => b.childrenLayout = Layout.Section),
  rt: new HtmlDriver<HTMLElement>("rt", false, b => b.childrenLayout = Layout.Section),
  ruby: new HtmlDriver<HTMLElement>("ruby", false, b => b.childrenLayout = Layout.Section),
  s: new HtmlDriver<HTMLElement>("s", false, b => b.childrenLayout = Layout.Section),
  samp: new HtmlDriver<HTMLElement>("samp", false, b => b.childrenLayout = Layout.Section),
  script: new HtmlDriver<HTMLScriptElement>("script", false, b => b.childrenLayout = Layout.Section),
  section: new HtmlDriver<HTMLElement>("section", false, b => b.childrenLayout = Layout.Section),
  select: new HtmlDriver<HTMLSelectElement>("select", false, b => b.childrenLayout = Layout.Section),
  small: new HtmlDriver<HTMLElement>("small", false, b => b.childrenLayout = Layout.Section),
  source: new HtmlDriver<HTMLSourceElement>("source", false, b => b.childrenLayout = Layout.Section),
  span: new HtmlDriver<HTMLSpanElement>("span", false, b => b.childrenLayout = Layout.Section),
  strong: new HtmlDriver<HTMLElement>("strong", false, b => b.childrenLayout = Layout.Section),
  style: new HtmlDriver<HTMLStyleElement>("style", false, b => b.childrenLayout = Layout.Section),
  sub: new HtmlDriver<HTMLElement>("sub", false, b => b.childrenLayout = Layout.Section),
  summary: new HtmlDriver<HTMLElement>("summary", false, b => b.childrenLayout = Layout.Section),
  sup: new HtmlDriver<HTMLElement>("sup", false, b => b.childrenLayout = Layout.Section),
  table: new HtmlDriver<HTMLTableElement>("table", false, b => b.childrenLayout = Layout.Section),
  template: new HtmlDriver<HTMLTemplateElement>("template", false, b => b.childrenLayout = Layout.Section),
  tbody: new HtmlDriver<HTMLTableSectionElement>("tbody", false, b => b.childrenLayout = Layout.Section),
  td: new HtmlDriver<HTMLTableCellElement>("td", false, b => b.childrenLayout = Layout.Section),
  textarea: new HtmlDriver<HTMLTextAreaElement>("textarea", false, b => b.childrenLayout = Layout.Section),
  tfoot: new HtmlDriver<HTMLTableSectionElement>("tfoot", false, b => b.childrenLayout = Layout.Section),
  th: new HtmlDriver<HTMLTableCellElement>("th", false, b => b.childrenLayout = Layout.Section),
  thead: new HtmlDriver<HTMLTableSectionElement>("thead", false, b => b.childrenLayout = Layout.Section),
  time: new HtmlDriver<HTMLElement>("time", false, b => b.childrenLayout = Layout.Section),
  title: new HtmlDriver<HTMLTitleElement>("title", false, b => b.childrenLayout = Layout.Section),
  tr: new HtmlDriver<HTMLTableRowElement>("tr", false, b => b.childrenLayout = Layout.Section),
  track: new HtmlDriver<HTMLTrackElement>("track", false, b => b.childrenLayout = Layout.Section),
  u: new HtmlDriver<HTMLElement>("u", false, b => b.childrenLayout = Layout.Section),
  ul: new HtmlDriver<HTMLUListElement>("ul", false, b => b.childrenLayout = Layout.Section),
  var: new HtmlDriver<HTMLElement>("var", false, b => b.childrenLayout = Layout.Section),
  video: new HtmlDriver<HTMLVideoElement>("video", false, b => b.childrenLayout = Layout.Section),
  wbr: new HtmlDriver<HTMLElement>("wbr", false, b => b.childrenLayout = Layout.Section),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', BlockKind.Chain),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>("svg", false, b => b.childrenLayout = Layout.Section),
  a: new SvgDriver<SVGAElement>("a", false, b => b.childrenLayout = Layout.Section),
  animate: new SvgDriver<SVGAnimateElement>("animate", false, b => b.childrenLayout = Layout.Section),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>("animateMotion", false, b => b.childrenLayout = Layout.Section),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>("animateTransform", false, b => b.childrenLayout = Layout.Section),
  circle: new SvgDriver<SVGCircleElement>("circle", false, b => b.childrenLayout = Layout.Section),
  clipPath: new SvgDriver<SVGClipPathElement>("clipPath", false, b => b.childrenLayout = Layout.Section),
  defs: new SvgDriver<SVGDefsElement>("defs", false, b => b.childrenLayout = Layout.Section),
  desc: new SvgDriver<SVGDescElement>("desc", false, b => b.childrenLayout = Layout.Section),
  ellipse: new SvgDriver<SVGEllipseElement>("ellipse", false, b => b.childrenLayout = Layout.Section),
  feBlend: new SvgDriver<SVGFEBlendElement>("feBlend", false, b => b.childrenLayout = Layout.Section),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>("feColorMatrix", false, b => b.childrenLayout = Layout.Section),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>("feComponentTransfer", false, b => b.childrenLayout = Layout.Section),
  feComposite: new SvgDriver<SVGFECompositeElement>("feComposite", false, b => b.childrenLayout = Layout.Section),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>("feConvolveMatrix", false, b => b.childrenLayout = Layout.Section),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>("feDiffuseLighting", false, b => b.childrenLayout = Layout.Section),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>("feDisplacementMap", false, b => b.childrenLayout = Layout.Section),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>("feDistantLight", false, b => b.childrenLayout = Layout.Section),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>("feDropShadow", false, b => b.childrenLayout = Layout.Section),
  feFlood: new SvgDriver<SVGFEFloodElement>("feFlood", false, b => b.childrenLayout = Layout.Section),
  feFuncA: new SvgDriver<SVGFEFuncAElement>("feFuncA", false, b => b.childrenLayout = Layout.Section),
  feFuncB: new SvgDriver<SVGFEFuncBElement>("feFuncB", false, b => b.childrenLayout = Layout.Section),
  feFuncG: new SvgDriver<SVGFEFuncGElement>("feFuncG", false, b => b.childrenLayout = Layout.Section),
  feFuncR: new SvgDriver<SVGFEFuncRElement>("feFuncR", false, b => b.childrenLayout = Layout.Section),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>("feGaussianBlur", false, b => b.childrenLayout = Layout.Section),
  feImage: new SvgDriver<SVGFEImageElement>("feImage", false, b => b.childrenLayout = Layout.Section),
  feMerge: new SvgDriver<SVGFEMergeElement>("feMerge", false, b => b.childrenLayout = Layout.Section),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>("feMergeNode", false, b => b.childrenLayout = Layout.Section),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>("feMorphology", false, b => b.childrenLayout = Layout.Section),
  feOffset: new SvgDriver<SVGFEOffsetElement>("feOffset", false, b => b.childrenLayout = Layout.Section),
  fePointLight: new SvgDriver<SVGFEPointLightElement>("fePointLight", false, b => b.childrenLayout = Layout.Section),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>("feSpecularLighting", false, b => b.childrenLayout = Layout.Section),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>("feSpotLight", false, b => b.childrenLayout = Layout.Section),
  feTile: new SvgDriver<SVGFETileElement>("feTile", false, b => b.childrenLayout = Layout.Section),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>("feTurbulence", false, b => b.childrenLayout = Layout.Section),
  filter: new SvgDriver<SVGFilterElement>("filter", false, b => b.childrenLayout = Layout.Section),
  foreignObject: new SvgDriver<SVGForeignObjectElement>("foreignObject", false, b => b.childrenLayout = Layout.Section),
  g: new SvgDriver<SVGGElement>("g", false, b => b.childrenLayout = Layout.Section),
  image: new SvgDriver<SVGImageElement>("image", false, b => b.childrenLayout = Layout.Section),
  line: new SvgDriver<SVGLineElement>("line", false, b => b.childrenLayout = Layout.Section),
  linearGradient: new SvgDriver<SVGLinearGradientElement>("linearGradient", false, b => b.childrenLayout = Layout.Section),
  marker: new SvgDriver<SVGMarkerElement>("marker", false, b => b.childrenLayout = Layout.Section),
  mask: new SvgDriver<SVGMaskElement>("mask", false, b => b.childrenLayout = Layout.Section),
  metadata: new SvgDriver<SVGMetadataElement>("metadata", false, b => b.childrenLayout = Layout.Section),
  mpath: new SvgDriver<SVGElement>("mpath", false, b => b.childrenLayout = Layout.Section),
  path: new SvgDriver<SVGPathElement>("path", false, b => b.childrenLayout = Layout.Section),
  pattern: new SvgDriver<SVGPatternElement>("pattern", false, b => b.childrenLayout = Layout.Section),
  polygon: new SvgDriver<SVGPolygonElement>("polygon", false, b => b.childrenLayout = Layout.Section),
  polyline: new SvgDriver<SVGPolylineElement>("polyline", false, b => b.childrenLayout = Layout.Section),
  radialGradient: new SvgDriver<SVGRadialGradientElement>("radialGradient", false, b => b.childrenLayout = Layout.Section),
  rect: new SvgDriver<SVGRectElement>("rect", false, b => b.childrenLayout = Layout.Section),
  stop: new SvgDriver<SVGStopElement>("stop", false, b => b.childrenLayout = Layout.Section),
  switch: new SvgDriver<SVGSwitchElement>("switch", false, b => b.childrenLayout = Layout.Section),
  symbol: new SvgDriver<SVGSymbolElement>("symbol", false, b => b.childrenLayout = Layout.Section),
  text: new SvgDriver<SVGTextElement>("text", false, b => b.childrenLayout = Layout.Section),
  textPath: new SvgDriver<SVGTextPathElement>("textPath", false, b => b.childrenLayout = Layout.Section),
  tspan: new SvgDriver<SVGTSpanElement>("tspan", false, b => b.childrenLayout = Layout.Section),
  use: new SvgDriver<SVGUseElement>("use", false, b => b.childrenLayout = Layout.Section),
  view: new SvgDriver<SVGViewElement>("view", false, b => b.childrenLayout = Layout.Section),
}
