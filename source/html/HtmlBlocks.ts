...
export function HtmlBody(body?: BlockBody<HTMLElement>, base?: BlockBody<HTMLElement>): VBlock<HTMLElement> {
  const driver = new StaticDriver(global.document.body, "HtmlBody", LayoutKind.Chain)
...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>("a", LayoutKind.Chain),
  abbr: new HtmlDriver<HTMLElement>("abbr", LayoutKind.Chain),
  address: new HtmlDriver<HTMLElement>("address", LayoutKind.Chain),
  area: new HtmlDriver<HTMLAreaElement>("area", LayoutKind.Chain),
  article: new HtmlDriver<HTMLElement>("article", LayoutKind.Chain),
  aside: new HtmlDriver<HTMLElement>("aside", LayoutKind.Chain),
  audio: new HtmlDriver<HTMLAudioElement>("audio", LayoutKind.Chain),
  b: new HtmlDriver<HTMLElement>("b", LayoutKind.Chain),
  base: new HtmlDriver<HTMLBaseElement>("base", LayoutKind.Chain),
  bdi: new HtmlDriver<HTMLElement>("bdi", LayoutKind.Chain),
  bdo: new HtmlDriver<HTMLElement>("bdo", LayoutKind.Chain),
  big: new HtmlDriver<HTMLElement>("big", LayoutKind.Chain),
  blockquote: new HtmlDriver<HTMLElement>("blockquote", LayoutKind.Chain),
  body: new HtmlDriver<HTMLBodyElement>("body", LayoutKind.Chain),
  br: new HtmlDriver<HTMLBRElement>("br", LayoutKind.Chain),
  button: new HtmlDriver<HTMLButtonElement>("button", LayoutKind.Chain),
  canvas: new HtmlDriver<HTMLCanvasElement>("canvas", LayoutKind.Chain),
  caption: new HtmlDriver<HTMLTableCaptionElement>("caption", LayoutKind.Chain),
  cite: new HtmlDriver<HTMLElement>("cite", LayoutKind.Chain),
  code: new HtmlDriver<HTMLElement>("code", LayoutKind.Chain),
  col: new HtmlDriver<HTMLTableColElement>("col", LayoutKind.Chain),
  colgroup: new HtmlDriver<HTMLTableColElement>("colgroup", LayoutKind.Chain),
  data: new HtmlDriver<HTMLDataElement>("data", LayoutKind.Chain),
  datalist: new HtmlDriver<HTMLDataListElement>("datalist", LayoutKind.Chain),
  dd: new HtmlDriver<HTMLElement>("dd", LayoutKind.Chain),
  del: new HtmlDriver<HTMLElement>("del", LayoutKind.Chain),
  details: new HtmlDriver<HTMLElement>("details", LayoutKind.Chain),
  dfn: new HtmlDriver<HTMLElement>("dfn", LayoutKind.Chain),
  div: new HtmlDriver<HTMLDivElement>("div", LayoutKind.Chain),
  dl: new HtmlDriver<HTMLDListElement>("dl", LayoutKind.Chain),
  dt: new HtmlDriver<HTMLElement>("dt", LayoutKind.Chain),
  em: new HtmlDriver<HTMLElement>("em", LayoutKind.Chain),
  embed: new HtmlDriver<HTMLEmbedElement>("embed", LayoutKind.Chain),
  fieldset: new HtmlDriver<HTMLFieldSetElement>("fieldset", LayoutKind.Chain),
  figcaption: new HtmlDriver<HTMLElement>("figcaption", LayoutKind.Chain),
  figure: new HtmlDriver<HTMLElement>("figure", LayoutKind.Chain),
  footer: new HtmlDriver<HTMLElement>("footer", LayoutKind.Chain),
  form: new HtmlDriver<HTMLFormElement>("form", LayoutKind.Chain),
  h1: new HtmlDriver<HTMLHeadingElement>("h1", LayoutKind.Chain),
  h2: new HtmlDriver<HTMLHeadingElement>("h2", LayoutKind.Chain),
  h3: new HtmlDriver<HTMLHeadingElement>("h3", LayoutKind.Chain),
  h4: new HtmlDriver<HTMLHeadingElement>("h4", LayoutKind.Chain),
  h5: new HtmlDriver<HTMLHeadingElement>("h5", LayoutKind.Chain),
  h6: new HtmlDriver<HTMLHeadingElement>("h6", LayoutKind.Chain),
  head: new HtmlDriver<HTMLHeadElement>("head", LayoutKind.Chain),
  header: new HtmlDriver<HTMLElement>("header", LayoutKind.Chain),
  hgroup: new HtmlDriver<HTMLElement>("hgroup", LayoutKind.Chain),
  hr: new HtmlDriver<HTMLHRElement>("hr", LayoutKind.Chain),
  html: new HtmlDriver<HTMLHtmlElement>("html", LayoutKind.Chain),
  i: new HtmlDriver<HTMLElement>("i", LayoutKind.Chain),
  iframe: new HtmlDriver<HTMLIFrameElement>("iframe", LayoutKind.Chain),
  img: new HtmlDriver<HTMLImageElement>("img", LayoutKind.Chain),
  input: new HtmlDriver<HTMLInputElement>("input", LayoutKind.Chain),
  ins: new HtmlDriver<HTMLModElement>("ins", LayoutKind.Chain),
  kbd: new HtmlDriver<HTMLElement>("kbd", LayoutKind.Chain),
  keygen: new HtmlDriver<HTMLElement>("keygen", LayoutKind.Chain),
  label: new HtmlDriver<HTMLLabelElement>("label", LayoutKind.Chain),
  legend: new HtmlDriver<HTMLLegendElement>("legend", LayoutKind.Chain),
  li: new HtmlDriver<HTMLLIElement>("li", LayoutKind.Chain),
  link: new HtmlDriver<HTMLLinkElement>("link", LayoutKind.Chain),
  main: new HtmlDriver<HTMLElement>("main", LayoutKind.Chain),
  map: new HtmlDriver<HTMLMapElement>("map", LayoutKind.Chain),
  mark: new HtmlDriver<HTMLElement>("mark", LayoutKind.Chain),
  menu: new HtmlDriver<HTMLElement>("menu", LayoutKind.Chain),
  menuitem: new HtmlDriver<HTMLElement>("menuitem", LayoutKind.Chain),
  meta: new HtmlDriver<HTMLMetaElement>("meta", LayoutKind.Chain),
  meter: new HtmlDriver<HTMLElement>("meter", LayoutKind.Chain),
  nav: new HtmlDriver<HTMLElement>("nav", LayoutKind.Chain),
  noindex: new HtmlDriver<HTMLElement>("noindex", LayoutKind.Chain),
  noscript: new HtmlDriver<HTMLElement>("noscript", LayoutKind.Chain),
  object: new HtmlDriver<HTMLObjectElement>("object", LayoutKind.Chain),
  ol: new HtmlDriver<HTMLOListElement>("ol", LayoutKind.Chain),
  optgroup: new HtmlDriver<HTMLOptGroupElement>("optgroup", LayoutKind.Chain),
  option: new HtmlDriver<HTMLOptionElement>("option", LayoutKind.Chain),
  output: new HtmlDriver<HTMLElement>("output", LayoutKind.Chain),
  p: new HtmlDriver<HTMLParagraphElement>("p", LayoutKind.Chain),
  param: new HtmlDriver<HTMLElement>("param", LayoutKind.Chain),
  picture: new HtmlDriver<HTMLElement>("picture", LayoutKind.Chain),
  pre: new HtmlDriver<HTMLPreElement>("pre", LayoutKind.Chain),
  progress: new HtmlDriver<HTMLProgressElement>("progress", LayoutKind.Chain),
  q: new HtmlDriver<HTMLQuoteElement>("q", LayoutKind.Chain),
  rp: new HtmlDriver<HTMLElement>("rp", LayoutKind.Chain),
  rt: new HtmlDriver<HTMLElement>("rt", LayoutKind.Chain),
  ruby: new HtmlDriver<HTMLElement>("ruby", LayoutKind.Chain),
  s: new HtmlDriver<HTMLElement>("s", LayoutKind.Chain),
  samp: new HtmlDriver<HTMLElement>("samp", LayoutKind.Chain),
  script: new HtmlDriver<HTMLScriptElement>("script", LayoutKind.Chain),
  section: new HtmlDriver<HTMLElement>("section", LayoutKind.Chain),
  select: new HtmlDriver<HTMLSelectElement>("select", LayoutKind.Chain),
  small: new HtmlDriver<HTMLElement>("small", LayoutKind.Chain),
  source: new HtmlDriver<HTMLSourceElement>("source", LayoutKind.Chain),
  span: new HtmlDriver<HTMLSpanElement>("span", LayoutKind.Chain),
  strong: new HtmlDriver<HTMLElement>("strong", LayoutKind.Chain),
  style: new HtmlDriver<HTMLStyleElement>("style", LayoutKind.Chain),
  sub: new HtmlDriver<HTMLElement>("sub", LayoutKind.Chain),
  summary: new HtmlDriver<HTMLElement>("summary", LayoutKind.Chain),
  sup: new HtmlDriver<HTMLElement>("sup", LayoutKind.Chain),
  table: new HtmlDriver<HTMLTableElement>("table", LayoutKind.Chain),
  template: new HtmlDriver<HTMLTemplateElement>("template", LayoutKind.Chain),
  tbody: new HtmlDriver<HTMLTableSectionElement>("tbody", LayoutKind.Chain),
  td: new HtmlDriver<HTMLTableCellElement>("td", LayoutKind.Chain),
  textarea: new HtmlDriver<HTMLTextAreaElement>("textarea", LayoutKind.Chain),
  tfoot: new HtmlDriver<HTMLTableSectionElement>("tfoot", LayoutKind.Chain),
  th: new HtmlDriver<HTMLTableCellElement>("th", LayoutKind.Chain),
  thead: new HtmlDriver<HTMLTableSectionElement>("thead", LayoutKind.Chain),
  time: new HtmlDriver<HTMLElement>("time", LayoutKind.Chain),
  title: new HtmlDriver<HTMLTitleElement>("title", LayoutKind.Chain),
  tr: new HtmlDriver<HTMLTableRowElement>("tr", LayoutKind.Chain),
  track: new HtmlDriver<HTMLTrackElement>("track", LayoutKind.Chain),
  u: new HtmlDriver<HTMLElement>("u", LayoutKind.Chain),
  ul: new HtmlDriver<HTMLUListElement>("ul", LayoutKind.Chain),
  var: new HtmlDriver<HTMLElement>("var", LayoutKind.Chain),
  video: new HtmlDriver<HTMLVideoElement>("video", LayoutKind.Chain),
  wbr: new HtmlDriver<HTMLElement>("wbr", LayoutKind.Chain),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', BlockKind.Chain),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>("svg", LayoutKind.Chain),
  a: new SvgDriver<SVGAElement>("a", LayoutKind.Chain),
  animate: new SvgDriver<SVGAnimateElement>("animate", LayoutKind.Chain),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>("animateMotion", LayoutKind.Chain),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>("animateTransform", LayoutKind.Chain),
  circle: new SvgDriver<SVGCircleElement>("circle", LayoutKind.Chain),
  clipPath: new SvgDriver<SVGClipPathElement>("clipPath", LayoutKind.Chain),
  defs: new SvgDriver<SVGDefsElement>("defs", LayoutKind.Chain),
  desc: new SvgDriver<SVGDescElement>("desc", LayoutKind.Chain),
  ellipse: new SvgDriver<SVGEllipseElement>("ellipse", LayoutKind.Chain),
  feBlend: new SvgDriver<SVGFEBlendElement>("feBlend", LayoutKind.Chain),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>("feColorMatrix", LayoutKind.Chain),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>("feComponentTransfer", LayoutKind.Chain),
  feComposite: new SvgDriver<SVGFECompositeElement>("feComposite", LayoutKind.Chain),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>("feConvolveMatrix", LayoutKind.Chain),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>("feDiffuseLighting", LayoutKind.Chain),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>("feDisplacementMap", LayoutKind.Chain),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>("feDistantLight", LayoutKind.Chain),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>("feDropShadow", LayoutKind.Chain),
  feFlood: new SvgDriver<SVGFEFloodElement>("feFlood", LayoutKind.Chain),
  feFuncA: new SvgDriver<SVGFEFuncAElement>("feFuncA", LayoutKind.Chain),
  feFuncB: new SvgDriver<SVGFEFuncBElement>("feFuncB", LayoutKind.Chain),
  feFuncG: new SvgDriver<SVGFEFuncGElement>("feFuncG", LayoutKind.Chain),
  feFuncR: new SvgDriver<SVGFEFuncRElement>("feFuncR", LayoutKind.Chain),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>("feGaussianBlur", LayoutKind.Chain),
  feImage: new SvgDriver<SVGFEImageElement>("feImage", LayoutKind.Chain),
  feMerge: new SvgDriver<SVGFEMergeElement>("feMerge", LayoutKind.Chain),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>("feMergeNode", LayoutKind.Chain),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>("feMorphology", LayoutKind.Chain),
  feOffset: new SvgDriver<SVGFEOffsetElement>("feOffset", LayoutKind.Chain),
  fePointLight: new SvgDriver<SVGFEPointLightElement>("fePointLight", LayoutKind.Chain),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>("feSpecularLighting", LayoutKind.Chain),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>("feSpotLight", LayoutKind.Chain),
  feTile: new SvgDriver<SVGFETileElement>("feTile", LayoutKind.Chain),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>("feTurbulence", LayoutKind.Chain),
  filter: new SvgDriver<SVGFilterElement>("filter", LayoutKind.Chain),
  foreignObject: new SvgDriver<SVGForeignObjectElement>("foreignObject", LayoutKind.Chain),
  g: new SvgDriver<SVGGElement>("g", LayoutKind.Chain),
  image: new SvgDriver<SVGImageElement>("image", LayoutKind.Chain),
  line: new SvgDriver<SVGLineElement>("line", LayoutKind.Chain),
  linearGradient: new SvgDriver<SVGLinearGradientElement>("linearGradient", LayoutKind.Chain),
  marker: new SvgDriver<SVGMarkerElement>("marker", LayoutKind.Chain),
  mask: new SvgDriver<SVGMaskElement>("mask", LayoutKind.Chain),
  metadata: new SvgDriver<SVGMetadataElement>("metadata", LayoutKind.Chain),
  mpath: new SvgDriver<SVGElement>("mpath", LayoutKind.Chain),
  path: new SvgDriver<SVGPathElement>("path", LayoutKind.Chain),
  pattern: new SvgDriver<SVGPatternElement>("pattern", LayoutKind.Chain),
  polygon: new SvgDriver<SVGPolygonElement>("polygon", LayoutKind.Chain),
  polyline: new SvgDriver<SVGPolylineElement>("polyline", LayoutKind.Chain),
  radialGradient: new SvgDriver<SVGRadialGradientElement>("radialGradient", LayoutKind.Chain),
  rect: new SvgDriver<SVGRectElement>("rect", LayoutKind.Chain),
  stop: new SvgDriver<SVGStopElement>("stop", LayoutKind.Chain),
  switch: new SvgDriver<SVGSwitchElement>("switch", LayoutKind.Chain),
  symbol: new SvgDriver<SVGSymbolElement>("symbol", LayoutKind.Chain),
  text: new SvgDriver<SVGTextElement>("text", LayoutKind.Chain),
  textPath: new SvgDriver<SVGTextPathElement>("textPath", LayoutKind.Chain),
  tspan: new SvgDriver<SVGTSpanElement>("tspan", LayoutKind.Chain),
  use: new SvgDriver<SVGUseElement>("use", LayoutKind.Chain),
  view: new SvgDriver<SVGViewElement>("view", LayoutKind.Chain),
}
