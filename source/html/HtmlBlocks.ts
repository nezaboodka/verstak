...
const HtmlTags = {
  a: new HtmlDriver<HTMLAnchorElement>('a', true, false),
  abbr: new HtmlDriver<HTMLElement>('abbr', true, false),
  address: new HtmlDriver<HTMLElement>('address', true, false),
  area: new HtmlDriver<HTMLAreaElement>('area', true, false),
  article: new HtmlDriver<HTMLElement>('article', true, false),
  aside: new HtmlDriver<HTMLElement>('aside', true, false),
  audio: new HtmlDriver<HTMLAudioElement>('audio', true, false),
  b: new HtmlDriver<HTMLElement>('b', true, false),
  base: new HtmlDriver<HTMLBaseElement>('base', true, false),
  bdi: new HtmlDriver<HTMLElement>('bdi', true, false),
  bdo: new HtmlDriver<HTMLElement>('bdo', true, false),
  big: new HtmlDriver<HTMLElement>('big', true, false),
  blockquote: new HtmlDriver<HTMLElement>('blockquote', true, false),
  body: new HtmlDriver<HTMLBodyElement>('body', true, false),
  br: new HtmlDriver<HTMLBRElement>('br', true, false),
  button: new HtmlDriver<HTMLButtonElement>('button', true, false),
  canvas: new HtmlDriver<HTMLCanvasElement>('canvas', true, false),
  caption: new HtmlDriver<HTMLTableCaptionElement>('caption', true, false),
  cite: new HtmlDriver<HTMLElement>('cite', true, false),
  code: new HtmlDriver<HTMLElement>('code', true, false),
  col: new HtmlDriver<HTMLTableColElement>('col', true, false),
  colgroup: new HtmlDriver<HTMLTableColElement>('colgroup', true, false),
  data: new HtmlDriver<HTMLDataElement>('data', true, false),
  datalist: new HtmlDriver<HTMLDataListElement>('datalist', true, false),
  dd: new HtmlDriver<HTMLElement>('dd', true, false),
  del: new HtmlDriver<HTMLElement>('del', true, false),
  details: new HtmlDriver<HTMLElement>('details', true, false),
  dfn: new HtmlDriver<HTMLElement>('dfn', true, false),
  div: new HtmlDriver<HTMLDivElement>('div', true, false),
  dl: new HtmlDriver<HTMLDListElement>('dl', true, false),
  dt: new HtmlDriver<HTMLElement>('dt', true, false),
  em: new HtmlDriver<HTMLElement>('em', true, false),
  embed: new HtmlDriver<HTMLEmbedElement>('embed', true, false),
  fieldset: new HtmlDriver<HTMLFieldSetElement>('fieldset', true, false),
  figcaption: new HtmlDriver<HTMLElement>('figcaption', true, false),
  figure: new HtmlDriver<HTMLElement>('figure', true, false),
  footer: new HtmlDriver<HTMLElement>('footer', true, false),
  form: new HtmlDriver<HTMLFormElement>('form', true, false),
  h1: new HtmlDriver<HTMLHeadingElement>('h1', true, false),
  h2: new HtmlDriver<HTMLHeadingElement>('h2', true, false),
  h3: new HtmlDriver<HTMLHeadingElement>('h3', true, false),
  h4: new HtmlDriver<HTMLHeadingElement>('h4', true, false),
  h5: new HtmlDriver<HTMLHeadingElement>('h5', true, false),
  h6: new HtmlDriver<HTMLHeadingElement>('h6', true, false),
  head: new HtmlDriver<HTMLHeadElement>('head', true, false),
  header: new HtmlDriver<HTMLElement>('header', true, false),
  hgroup: new HtmlDriver<HTMLElement>('hgroup', true, false),
  hr: new HtmlDriver<HTMLHRElement>('hr', true, false),
  html: new HtmlDriver<HTMLHtmlElement>('html', true, false),
  i: new HtmlDriver<HTMLElement>('i', true, false),
  iframe: new HtmlDriver<HTMLIFrameElement>('iframe', true, false),
  img: new HtmlDriver<HTMLImageElement>('img', true, false),
  input: new HtmlDriver<HTMLInputElement>('input', true, false),
  ins: new HtmlDriver<HTMLModElement>('ins', true, false),
  kbd: new HtmlDriver<HTMLElement>('kbd', true, false),
  keygen: new HtmlDriver<HTMLElement>('keygen', true, false),
  label: new HtmlDriver<HTMLLabelElement>('label', true, false),
  legend: new HtmlDriver<HTMLLegendElement>('legend', true, false),
  li: new HtmlDriver<HTMLLIElement>('li', true, false),
  link: new HtmlDriver<HTMLLinkElement>('link', true, false),
  main: new HtmlDriver<HTMLElement>('main', true, false),
  map: new HtmlDriver<HTMLMapElement>('map', true, false),
  mark: new HtmlDriver<HTMLElement>('mark', true, false),
  menu: new HtmlDriver<HTMLElement>('menu', true, false),
  menuitem: new HtmlDriver<HTMLElement>('menuitem', true, false),
  meta: new HtmlDriver<HTMLMetaElement>('meta', true, false),
  meter: new HtmlDriver<HTMLElement>('meter', true, false),
  nav: new HtmlDriver<HTMLElement>('nav', true, false),
  noindex: new HtmlDriver<HTMLElement>('noindex', true, false),
  noscript: new HtmlDriver<HTMLElement>('noscript', true, false),
  object: new HtmlDriver<HTMLObjectElement>('object', true, false),
  ol: new HtmlDriver<HTMLOListElement>('ol', true, false),
  optgroup: new HtmlDriver<HTMLOptGroupElement>('optgroup', true, false),
  option: new HtmlDriver<HTMLOptionElement>('option', true, false),
  output: new HtmlDriver<HTMLElement>('output', true, false),
  p: new HtmlDriver<HTMLParagraphElement>('p', true, false),
  param: new HtmlDriver<HTMLElement>('param', true, false),
  picture: new HtmlDriver<HTMLElement>('picture', true, false),
  pre: new HtmlDriver<HTMLPreElement>('pre', true, false),
  progress: new HtmlDriver<HTMLProgressElement>('progress', true, false),
  q: new HtmlDriver<HTMLQuoteElement>('q', true, false),
  rp: new HtmlDriver<HTMLElement>('rp', true, false),
  rt: new HtmlDriver<HTMLElement>('rt', true, false),
  ruby: new HtmlDriver<HTMLElement>('ruby', true, false),
  s: new HtmlDriver<HTMLElement>('s', true, false),
  samp: new HtmlDriver<HTMLElement>('samp', true, false),
  script: new HtmlDriver<HTMLScriptElement>('script', true, false),
  section: new HtmlDriver<HTMLElement>('section', true, false),
  select: new HtmlDriver<HTMLSelectElement>('select', true, false),
  small: new HtmlDriver<HTMLElement>('small', true, false),
  source: new HtmlDriver<HTMLSourceElement>('source', true, false),
  span: new HtmlDriver<HTMLSpanElement>('span', true, false),
  strong: new HtmlDriver<HTMLElement>('strong', true, false),
  style: new HtmlDriver<HTMLStyleElement>('style', true, false),
  sub: new HtmlDriver<HTMLElement>('sub', true, false),
  summary: new HtmlDriver<HTMLElement>('summary', true, false),
  sup: new HtmlDriver<HTMLElement>('sup', true, false),
  table: new HtmlDriver<HTMLTableElement>('table', true, false),
  template: new HtmlDriver<HTMLTemplateElement>('template', true, false),
  tbody: new HtmlDriver<HTMLTableSectionElement>('tbody', true, false),
  td: new HtmlDriver<HTMLTableCellElement>('td', true, false),
  textarea: new HtmlDriver<HTMLTextAreaElement>('textarea', true, false),
  tfoot: new HtmlDriver<HTMLTableSectionElement>('tfoot', true, false),
  th: new HtmlDriver<HTMLTableCellElement>('th', true, false),
  thead: new HtmlDriver<HTMLTableSectionElement>('thead', true, false),
  time: new HtmlDriver<HTMLElement>('time', true, false),
  title: new HtmlDriver<HTMLTitleElement>('title', true, false),
  tr: new HtmlDriver<HTMLTableRowElement>('tr', true, false),
  track: new HtmlDriver<HTMLTrackElement>('track', true, false),
  u: new HtmlDriver<HTMLElement>('u', true, false),
  ul: new HtmlDriver<HTMLUListElement>('ul', true, false),
  var: new HtmlDriver<HTMLElement>('var', true, false),
  video: new HtmlDriver<HTMLVideoElement>('video', true, false),
  wbr: new HtmlDriver<HTMLElement>('wbr', true, false),
  // webview: new HtmlNodeFactory<HTMLWebViewElement>('webview', true, false),
}

const SvgTags = {
  svg: new SvgDriver<SVGSVGElement>('svg', true, false),
  a: new SvgDriver<SVGAElement>('a', true, false),
  animate: new SvgDriver<SVGAnimateElement>('animate', true, false),
  animateMotion: new SvgDriver<SVGAnimateMotionElement>('animateMotion', true, false),
  animateTransform: new SvgDriver<SVGAnimateTransformElement>('animateTransform', true, false),
  circle: new SvgDriver<SVGCircleElement>('circle', true, false),
  clipPath: new SvgDriver<SVGClipPathElement>('clipPath', true, false),
  defs: new SvgDriver<SVGDefsElement>('defs', true, false),
  desc: new SvgDriver<SVGDescElement>('desc', true, false),
  ellipse: new SvgDriver<SVGEllipseElement>('ellipse', true, false),
  feBlend: new SvgDriver<SVGFEBlendElement>('feBlend', true, false),
  feColorMatrix: new SvgDriver<SVGFEColorMatrixElement>('feColorMatrix', true, false),
  feComponentTransfer: new SvgDriver<SVGFEComponentTransferElement>('feComponentTransfer', true, false),
  feComposite: new SvgDriver<SVGFECompositeElement>('feComposite', true, false),
  feConvolveMatrix: new SvgDriver<SVGFEConvolveMatrixElement>('feConvolveMatrix', true, false),
  feDiffuseLighting: new SvgDriver<SVGFEDiffuseLightingElement>('feDiffuseLighting', true, false),
  feDisplacementMap: new SvgDriver<SVGFEDisplacementMapElement>('feDisplacementMap', true, false),
  feDistantLight: new SvgDriver<SVGFEDistantLightElement>('feDistantLight', true, false),
  feDropShadow: new SvgDriver<SVGFEDropShadowElement>('feDropShadow', true, false),
  feFlood: new SvgDriver<SVGFEFloodElement>('feFlood', true, false),
  feFuncA: new SvgDriver<SVGFEFuncAElement>('feFuncA', true, false),
  feFuncB: new SvgDriver<SVGFEFuncBElement>('feFuncB', true, false),
  feFuncG: new SvgDriver<SVGFEFuncGElement>('feFuncG', true, false),
  feFuncR: new SvgDriver<SVGFEFuncRElement>('feFuncR', true, false),
  feGaussianBlur: new SvgDriver<SVGFEGaussianBlurElement>('feGaussianBlur', true, false),
  feImage: new SvgDriver<SVGFEImageElement>('feImage', true, false),
  feMerge: new SvgDriver<SVGFEMergeElement>('feMerge', true, false),
  feMergeNode: new SvgDriver<SVGFEMergeNodeElement>('feMergeNode', true, false),
  feMorphology: new SvgDriver<SVGFEMorphologyElement>('feMorphology', true, false),
  feOffset: new SvgDriver<SVGFEOffsetElement>('feOffset', true, false),
  fePointLight: new SvgDriver<SVGFEPointLightElement>('fePointLight', true, false),
  feSpecularLighting: new SvgDriver<SVGFESpecularLightingElement>('feSpecularLighting', true, false),
  feSpotLight: new SvgDriver<SVGFESpotLightElement>('feSpotLight', true, false),
  feTile: new SvgDriver<SVGFETileElement>('feTile', true, false),
  feTurbulence: new SvgDriver<SVGFETurbulenceElement>('feTurbulence', true, false),
  filter: new SvgDriver<SVGFilterElement>('filter', true, false),
  foreignObject: new SvgDriver<SVGForeignObjectElement>('foreignObject', true, false),
  g: new SvgDriver<SVGGElement>('g', true, false),
  image: new SvgDriver<SVGImageElement>('image', true, false),
  line: new SvgDriver<SVGLineElement>('line', true, false),
  linearGradient: new SvgDriver<SVGLinearGradientElement>('linearGradient', true, false),
  marker: new SvgDriver<SVGMarkerElement>('marker', true, false),
  mask: new SvgDriver<SVGMaskElement>('mask', true, false),
  metadata: new SvgDriver<SVGMetadataElement>('metadata', true, false),
  mpath: new SvgDriver<SVGElement>('mpath', true, false),
  path: new SvgDriver<SVGPathElement>('path', true, false),
  pattern: new SvgDriver<SVGPatternElement>('pattern', true, false),
  polygon: new SvgDriver<SVGPolygonElement>('polygon', true, false),
  polyline: new SvgDriver<SVGPolylineElement>('polyline', true, false),
  radialGradient: new SvgDriver<SVGRadialGradientElement>('radialGradient', true, false),
  rect: new SvgDriver<SVGRectElement>('rect', true, false),
  stop: new SvgDriver<SVGStopElement>('stop', true, false),
  switch: new SvgDriver<SVGSwitchElement>('switch', true, false),
  symbol: new SvgDriver<SVGSymbolElement>('symbol', true, false),
  text: new SvgDriver<SVGTextElement>('text', true, false),
  textPath: new SvgDriver<SVGTextPathElement>('textPath', true, false),
  tspan: new SvgDriver<SVGTSpanElement>('tspan', true, false),
  use: new SvgDriver<SVGUseElement>('use', true, false),
  view: new SvgDriver<SVGViewElement>('view', true, false),
}
